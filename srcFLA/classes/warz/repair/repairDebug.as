package warz.repair {
	public class repairDebug {
		...
		public	var	api:warz.repair.repair;

		static public function initDebug(api:warz.repair.repair) {
			...
			api.addBackpackItem(0, 0, 200009, 1, 1, 1, "blalsa");
			...
			api.addBackpackItemRepairInfo(0, 50, 1000);
			api.addBackpackItemRepairInfo(3, 25, 666);
			api.addBackpackItemRepairInfo(11, 90, 50);
			api.addBackpackItemRepairInfo(10, 100, 20);

			api.showRepairScreen();
		}
	}
}
