package warz.repair {
	...
	public class repair extends MovieClip {
		public var isDebug:Boolean = false;
		
		public var Main:MovieClip = null;

		static public var api:repair = null;
		...
		public  var BackpackRepairInfo:Array = null;
		
		public function repair(main:MovieClip) 
		{
			api = this;
			Main = main;
			...
			StoreDB = new Array ();
			SlotDB = new Array ([], [], [], [], []);
			BackpackRepairInfo = new Array();
		}

		public function showRepairScreen()
		{
			Main.Activate();
		}
		
		public function hideRepairScreen()
		{
			Main.Deactivate();
		}
		...
		{
			BackpackRepairInfo.push({slotID:slotID, itemCondition:itemCondition, price:price});
		}
		
		public function getRepairInfo(slotID:uint)
		{
			for(var i=0; i<BackpackRepairInfo.length; ++i)
			{
				if(BackpackRepairInfo[i]["slotID"] == slotID)
					return BackpackRepairInfo[i];
			}
			return null;
		}
