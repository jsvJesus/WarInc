...
public partial class api_SrvGiveItemInMinutes : WOApiWebPage
{
    protected override void Execute()
    {
        ...
        string BuyMinutes = web.Param("BuyMinutes");

        SqlCommand sqcmd = new SqlCommand();
        sqcmd.CommandType = CommandType.StoredProcedure;
        sqcmd.CommandText = "WO_SRV_GIVEITEM_IN_MINUTES";
        sqcmd.Parameters.AddWithValue("@in_IP", LastIP);
        sqcmd.Parameters.AddWithValue("@in_CustomerID", CustomerID);
        sqcmd.Parameters.AddWithValue("@in_ItemId", ItemID);
        sqcmd.Parameters.AddWithValue("@in_BuyMinutes", BuyMinutes);
