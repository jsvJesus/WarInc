...
public partial class api_ModifySlot : WOApiWebPage
{
    protected override void Execute()
    {
        ...
        string SlotID = web.Param("SlotID");
        ...
        sqcmd.CommandText = "WO_UPDATELOADOUT";
        sqcmd.Parameters.AddWithValue("@in_IP", LastIP);
        sqcmd.Parameters.AddWithValue("@in_CustomerID", CustomerID);
        sqcmd.Parameters.AddWithValue("@in_SlotID", SlotID);
