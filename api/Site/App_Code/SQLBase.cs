...
{
    string server = "192.95.7.127,4685"; // ip host
    string user = "sa";
    string pass = "SqL2090SenhaPika@#"; /// password  sql server 
    string workdb = "warinc";   ///database name 
    ...
    public SQLBase()
    {
        if (ConfigurationManager.AppSettings.Get("WO_Region") == "RU")
        {
            ...
            user = "sa";
            pass = "SqL2090SenhaPika@#";
        }
        else if (ConfigurationManager.AppSettings.Get("WO_Region") == "RU")
        {
            server = "192.95.7.127,4685";
            user = "sa";
            pass = "SqL2090SenhaPika@#";
        ...
        {
            server = "192.95.7.127,4685";  ///only  will need changer this here what u can cheking u porting what u setting .. here this all ok
            user = "sa";
            pass = "SqL2090SenhaPika@#";
        }
    }
