...
static int StringToGBMapID(char* str)
{
  ...
  if(stricmp(str, "MAPID_wr_dust_old") == 0)
	  return GBGameInfo::MAPID_wr_dust_old;
  if(stricmp(str, "MAPID_WO_Wasteland") == 0)
	  return GBGameInfo::MAPID_WO_Wasteland;
  if(stricmp(str, "MAPID_wo_wasteland_classic") == 0)
	  return GBGameInfo::MAPID_wo_wasteland_classic;
  ...
  if(stricmp(str, "MAPID_WO_Torn_classic") == 0)
	  return GBGameInfo::MAPID_WO_Torn_classic;
  if(stricmp(str, "MAPID_wo_dm_shippingyard2") == 0)
	  return GBGameInfo::MAPID_wo_dm_shippingyard2;
  if(stricmp(str, "MAPID_wo_crossroadsredux_cq") == 0)
	  return GBGameInfo::MAPID_wo_crossroadsredux_cq;
  if(stricmp(str, "MAPID_WO_Burning_Sea_classic") == 0)
	  return GBGameInfo::MAPID_WO_Burning_Sea_classic;
  if(stricmp(str, "MAPID_MC_NukeTownDM") == 0)
	  return GBGameInfo::MAPID_MC_NukeTownDM;
  if(stricmp(str, "MAPID_MC_ForceCity") == 0)
	  return GBGameInfo::MAPID_MC_ForceCity;
  if(stricmp(str, "MAPID_wo_valley") == 0)
	  return GBGameInfo::MAPID_wo_valley;
