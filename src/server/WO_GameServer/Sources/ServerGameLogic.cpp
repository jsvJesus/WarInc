...
bool ServerGameLogic::DropLootBox(obj_ServerPlayer* killedPlr)
{
	...
	if(!(ginfo_.mapId == GBGameInfo::MAPID_WO_Crossroads16 ||
        ...
        ginfo_.mapId == GBGameInfo::MAPID_WO_Torn_classic ||
        ginfo_.mapId == GBGameInfo::MAPID_wo_dm_shippingyard2 ||
        ginfo_.mapId == GBGameInfo::MAPID_wo_crossroadsredux_cq ||
        ginfo_.mapId == GBGameInfo::MAPID_WO_Burning_Sea_classic ||
        ginfo_.mapId == GBGameInfo::MAPID_MC_NukeTownDM ||
        ginfo_.mapId == GBGameInfo::MAPID_MC_ForceCity ||
        ginfo_.mapId == GBGameInfo::MAPID_wo_wasteland_classic ||
        ginfo_.mapId == GBGameInfo::MAPID_wo_valley ||
		ginfo_.mapId == GBGameInfo::MAPID_WO_Nightfall_CQ ||
		ginfo_.mapId == GBGameInfo::MAPID_wo_TornTown_tdm)
		)
		return false;
...
void ServerGameLogic::AddDirectPlayerReward(obj_ServerPlayer* plr, const wiStatsTracking& in_rwd, const char* rewardName)
{
    ...
    case GBGameInfo::MAPID_MC_ForceCity:
