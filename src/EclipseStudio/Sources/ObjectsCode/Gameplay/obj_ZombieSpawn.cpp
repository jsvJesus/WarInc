...
//////////////////////////////////////////////////////////////////////////
	...
	void InitSoundIDs()
	{
		...
		gSndZombieAttack1ID = SoundSys.GetEventIDByPath("Sounds/WarZ/Zombie sounds/ZOMBIE_ATTACK_M");
		gSndZombieAttack2ID = SoundSys.GetEventIDByPath("Sounds/WarZ/Zombie sounds/ZOMBIE_ATTACK_F");
		gSndZombieBreatheID= SoundSys.GetEventIDByPath("Sounds/WarZ/Zombie sounds/ZOMBIE_DAMAGE_F");
		gSndZombieGrowlID = SoundSys.GetEventIDByPath("Sounds/WarZ/Zombie sounds/ZOMBIE_WALK");
	}
}
