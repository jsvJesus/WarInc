...
void SetupAnimationConstants( int iInst )
{
	...
	D3D_V( r3dRenderer->SetSamplerState( D3DVERTEXTEXTURESAMPLER0, D3DSAMP_ADDRESSU, D3DTADDRESS_WRAP ) ) ;
	D3D_V( r3dRenderer->SetSamplerState( D3DVERTEXTEXTURESAMPLER0, D3DSAMP_ADDRESSV, D3DTADDRESS_WRAP ) ) ;
