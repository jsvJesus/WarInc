...
int GetXMLVal( const char* Name, pugi::xml_node& node, std::string* oVal )
{
	if( node.empty() )
		return  0;
...
int SetXMLVal( const char* Name, pugi::xml_node& node, char* val )
{
	pugi::xml_node valNode = node.append_child();
...
int SetXMLVal( const char* Name, pugi::xml_node& node, r3dColor* val )
{
	pugi::xml_node valNode = node.append_child();
...
int SetXMLVal( const char* Name, pugi::xml_node& node, r3dPoint3D* val )
{
	pugi::xml_node valNode = node.append_child();
...
int SetXMLVal( const char* Name, pugi::xml_node& node, r3dPoint2D* val )
{
	pugi::xml_node valNode = node.append_child();
