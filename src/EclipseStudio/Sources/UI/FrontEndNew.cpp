...
void FrontendUI::processNewGameList()
{
	...
	for(int i=0; i<numGames; i++) 
	{
        ...
        case GBGameInfo::MAPID_wr_dust_old:
			var[5].SetStringW(gLangMngr.getString("MapDustOldName"));
			var[6].SetString("$Levels/wr_dust_old/map_icon.dds");
			break;
       ...
       case GBGameInfo::MAPID_wo_wasteland_classic:
			var[5].SetStringW(gLangMngr.getString("MapwastelandclassicName"));
			var[6].SetString("$Levels/wo_wasteland_classic/map_icon.dds");
			break;
		...
		case GBGameInfo::MAPID_wo_TornTown_tdm:
			var[5].SetStringW(gLangMngr.getString("MaptorntownName"));
		...
		case GBGameInfo::MAPID_wo_valley:
			var[5].SetStringW(gLangMngr.getString("MapvalleyName"));
			var[6].SetString("$Levels/wo_valley/map_icon.dds");
            break;
		case GBGameInfo::MAPID_WO_Torn_classic:
			var[5].SetStringW(gLangMngr.getString("MapTornClassicName"));
			var[6].SetString("$Levels/WO_Torn_classic/map_icon.dds");
            break;
		case GBGameInfo::MAPID_wo_dm_shippingyard2:
			var[5].SetStringW(gLangMngr.getString("Mapshippingyard2Name"));
			var[6].SetString("$Levels/wo_dm_shippingyard2/map_icon.dds");
            break;
		case GBGameInfo::MAPID_wo_crossroadsredux_cq:
			var[5].SetStringW(gLangMngr.getString("MapCrossroadsReduxName"));
			var[6].SetString("$Levels/wo_crossroadsredux_cq/map_icon.dds");
            break;
		case GBGameInfo::MAPID_WO_Burning_Sea_classic:
			var[5].SetStringW(gLangMngr.getString("MapBurningSeaClassicName"));
			var[6].SetString("$Levels/WO_Burning_Sea_classic/map_icon.dds");
            break;
		case GBGameInfo::MAPID_MC_NukeTownDM:
			var[5].SetStringW(gLangMngr.getString("MapNukeTownName"));
			var[6].SetString("$Levels/MC_NukeTownDM/map_icon.dds");
            break;
...
#define MAKE_CALLBACK(FUNC) new r3dScaleformMovie::TGFxEICallback<FrontendUI>(this, &FrontendUI::FUNC)
	...
	// add game modes
	{
		...
		gfxMovie.Invoke("_root.api.addGameMode", var, 4);
 		...
 		var[0].SetNumber(3);
 		var[1].SetStringW(gLangMngr.getString("$GameMode_SIEGE"));
		var[2].SetString("Siege");
		var[3].SetStringW(gLangMngr.getString("SiegeDesc"));
		gfxMovie.Invoke("_root.api.addGameMode", var, 4);
	...
	// add game maps
	{
addGameMap(GBGameInfo::MAPID_WO_Torn_classic, gLangMngr.getString("MapTornClassicName"), "$Levels/WO_Torn_classic/map_icon.dds", gLangMngr.getString("MapTornClassicDesc"), "19");
		addGameMap_numBasicPlayers(GBGameInfo::MAPID_WO_Torn_classic, 32);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_WO_Torn_classic, 16);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_WO_Torn_classic, 32);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_WO_Torn_classic, 64);
        ...
        addGameMap(GBGameInfo::MAPID_WO_Burning_Sea_classic, gLangMngr.getString("MapBurningSeaClassicName"), "$Levels/WO_Burning_Sea_classic/map_icon.dds", gLangMngr.getString("MapBurningSeaClassicDesc"), "19");
		addGameMap_numBasicPlayers(GBGameInfo::MAPID_WO_Burning_Sea_classic, 32);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_WO_Burning_Sea_classic, 16);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_WO_Burning_Sea_classic, 32);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_WO_Burning_Sea_classic, 64);

        addGameMap(GBGameInfo::MAPID_wo_crossroadsredux_cq, gLangMngr.getString("MapCrossroadsReduxName"), "$Levels/wo_crossroadsredux_cq/map_icon.dds", gLangMngr.getString("MapCrossroadsReduxDesc"), "19");
		addGameMap_numBasicPlayers(GBGameInfo::MAPID_wo_crossroadsredux_cq, 32);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_crossroadsredux_cq, 16);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_crossroadsredux_cq, 32);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_crossroadsredux_cq, 64);

        addGameMap(GBGameInfo::MAPID_wo_dm_shippingyard2, gLangMngr.getString("Mapshippingyard2Name"), "$Levels/wo_dm_shippingyard2/map_icon.dds", gLangMngr.getString("Mapshippingyard2Desc"), "29");
		addGameMap_numBasicPlayers(GBGameInfo::MAPID_wo_dm_shippingyard2, 32);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_dm_shippingyard2, 16);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_dm_shippingyard2, 32);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_dm_shippingyard2, 64);

        addGameMap(GBGameInfo::MAPID_MC_NukeTownDM, gLangMngr.getString("MapNukeTownName"), "$Levels/MC_NukeTownDM/map_icon.dds", gLangMngr.getString("MapNukeTownDesc"), "29");
		addGameMap_numBasicPlayers(GBGameInfo::MAPID_MC_NukeTownDM, 32);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_MC_NukeTownDM, 16);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_MC_NukeTownDM, 32);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_MC_NukeTownDM, 64);
        ...
        addGameMap(GBGameInfo::MAPID_wo_wasteland_classic, gLangMngr.getString("MapwastelandclassicName"), "$Levels/wo_wasteland_classic/map_icon.dds", gLangMngr.getString("MapwastelandclassicDesc"), "29");
		addGameMap_numBasicPlayers(GBGameInfo::MAPID_wo_wasteland_classic, 16);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_wasteland_classic, 10);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_wasteland_classic, 16);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_wasteland_classic, 32);
        ...
        addGameMap(GBGameInfo::MAPID_wr_dust_old, gLangMngr.getString("MapDustOldName"), "$Levels/wr_dust_old/map_icon.dds", gLangMngr.getString("MapDustOldDesc"), "4");
		addGameMap_numBasicPlayers(GBGameInfo::MAPID_wr_dust_old, 16);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wr_dust_old, 10);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wr_dust_old, 16);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wr_dust_old, 32);
        ...
        addGameMap(GBGameInfo::MAPID_wo_valley, gLangMngr.getString("MapvalleyName"), "$Levels/wo_valley/map_icon.dds", gLangMngr.getString("MapvalleyDesc"), "19");
        ...
        addGameMap(GBGameInfo::MAPID_wo_TornTown_tdm,gLangMngr.getString("MaptorntownName"), "$Levels/wo_TornTown_tdm/map_icon.dds",gLangMngr.getString("MaptorntownDesc"), "29");
		addGameMap_numBasicPlayers(GBGameInfo::MAPID_wo_TornTown_tdm, 16);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_TornTown_tdm, 10);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_TornTown_tdm, 16);
		addGameMap_numPremiumPlayers(GBGameInfo::MAPID_wo_TornTown_tdm, 32);
