...
namespace
{
	char BLUR_PS_NAME_BASE[] = "PS_SSAO_BLUR000";
...
void GetSSAOBlurPSName( char(&buf)[32], int tapCount, int scaled, int normals )
{
...
void FillSSAOBlurMacros( ShaderMacros& oMacros, int tapCount, int scaled, int normals )
{
	oMacros.Resize( 3 ) ;
