...
float DepthOfField_NearAmplify	= 1.5f;
...
void InitCommonPostFX()
{
	...
	int i = 0 ;
	gPFX_BlurH[ i ++ ] = new PFX_DirectionalBlurOptimized( 1.0f, 0.0f, 2 ) ;
	gPFX_BlurH[ i ++ ] = new PFX_DirectionalBlurOptimized( 1.0f, 0.0f, 4 );
	gPFX_BlurH[ i ++ ] = new PFX_DirectionalBlurOptimized( 1.0f, 0.0f, 6 );
	gPFX_BlurH[ i ++ ] = new PFX_DirectionalBlurOptimized( 1.0f, 0.0f, 8 );
	gPFX_BlurH[ i ++ ] = new PFX_DirectionalBlurOptimized( 1.0f, 0.0f, 10 );
	gPFX_BlurH[ i ++ ] = new PFX_DirectionalBlurOptimized( 1.0f, 0.0f, 12 );
	gPFX_BlurH[ i ++ ] = new PFX_DirectionalBlurOptimized( 1.0f, 0.0f, 14 );
	gPFX_BlurH[ i ++ ] = new PFX_DirectionalBlurOptimized( 1.0f, 0.0f, 16 );

	i = 0 ;

	gPFX_BlurV[ i ++ ] = new PFX_DirectionalBlurOptimized( 0.0f, 1.0f, 2 ) ;
	gPFX_BlurV[ i ++ ] = new PFX_DirectionalBlurOptimized( 0.0f, 1.0f, 4 ) ;
	gPFX_BlurV[ i ++ ] = new PFX_DirectionalBlurOptimized( 0.0f, 1.0f, 6 ) ;
	gPFX_BlurV[ i ++ ] = new PFX_DirectionalBlurOptimized( 0.0f, 1.0f, 8 ) ;
	gPFX_BlurV[ i ++ ] = new PFX_DirectionalBlurOptimized( 0.0f, 1.0f, 10 ) ;
	gPFX_BlurV[ i ++ ] = new PFX_DirectionalBlurOptimized( 0.0f, 1.0f, 12 ) ;
	gPFX_BlurV[ i ++ ] = new PFX_DirectionalBlurOptimized( 0.0f, 1.0f, 14 ) ;
	gPFX_BlurV[ i ++ ] = new PFX_DirectionalBlurOptimized( 0.0f, 1.0f, 16 ) ;
