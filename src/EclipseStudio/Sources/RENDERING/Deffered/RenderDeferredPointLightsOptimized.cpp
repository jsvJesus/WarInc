...
void PointLightsRenderer::Init()
{
	...
	tileGridVB = new r3dVertexBuffer(vbSize, sizeof(TileGridVertex), 0, false, false, BufferMem);
	...
	tileGridIB = new r3dIndexBuffer(ibSize, false, 2, BufferMem);
	...
	tileInstanceData = new r3dVertexBuffer(instVBSize, sizeof(float), 0, true, false, BufferMem);
