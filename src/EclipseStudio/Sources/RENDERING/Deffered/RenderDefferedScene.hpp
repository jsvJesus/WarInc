...
void RenderDeferredScene1()
{
	...
	if( r_need_reset_exporue->GetInt() )
	{
...
#ifndef FINAL_BUILD
		extern int DrawTerrainMatHeaviness;
		if( DrawTerrainMatHeaviness )
		{
			Terrain1->DrawMaterialHeavyness();
		}
#endif
