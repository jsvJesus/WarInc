...
//////////////////////////////////////////////////////////////////////////
	...
	public:
		...
		, numberOfVertexElements(0)
		{
			...
			vb = new r3dVertexBuffer(desc.maxVerts, vertexSize, 0, desc.hint == NxRenderBufferHint::DYNAMIC);
		}
...
//////////////////////////////////////////////////////////////////////////
	...
	public:
		...
		: ib(0)
		{
			ib = new r3dIndexBuffer(desc.maxIndices, desc.hint == NxRenderBufferHint::DYNAMIC, desc.format == NxRenderDataFormat::UINT1 ? 4 : 2);
		}
...
//////////////////////////////////////////////////////////////////////////
	...
	public:
		...
		, numberOfBones(0)
		{
			...
			boneMatrices = new D3DXVECTOR4[bufferSize];
...
{
	return new UserRenderVertexBuffer(desc);
}
...
{
	return new UserRenderIndexBuffer(desc);
}
...
{
	return new UserRenderBoneBuffer(desc);
}
...
{
	return new UserRenderResource(desc);
}
