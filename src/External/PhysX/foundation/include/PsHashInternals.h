	...
	namespace internal
	{
		...
		private:
			...
			void reserveInternal(PxU32 size)
			{
				...
				memset(newHash, PxU32(EOL), newHashSize * sizeof(PxU32));
				...
				else
				{
					...
					memcpy(newEntriesNext, mEntriesNext, mEntriesCapacity*sizeof(PxU32));
