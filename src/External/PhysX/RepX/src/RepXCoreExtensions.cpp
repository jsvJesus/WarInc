...
namespace physx { namespace repx {
	...
	{
		StrToImpl<PxF32>().strtoShort( datatype.pos[0], ioData );
		StrToImpl<PxF32>().strtoShort( datatype.pos[1], ioData );
		StrToImpl<PxF32>().strtoShort( datatype.pos[2], ioData );
		StrToImpl<PxF32>().strtoShort( datatype.invWeight, ioData );
	}
	};
	...
	void strto( PxClothCollisionSphere& datatype, char*& ioData )
	{
		...
		StrToImpl<PxF32>().strtoShort( datatype.pos[1], ioData );
		StrToImpl<PxF32>().strtoShort( datatype.pos[2], ioData );
		StrToImpl<PxF32>().strtoShort( datatype.radius, ioData );
	}
	};
