...
/*		if(direction.y==0.0f)
        ...
        // ptumik: commented out that if block, with it player can jump on almost vertical surfaces and stay there
		/*if(mWalkExperiment)
		{
...
//	const PxU32 MaxIterDown = mWalkExperiment ? MaxIter : 1;
