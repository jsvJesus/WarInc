...
static void getMetaData_BitMap(PxSerialStream& stream)
{
	...
	public:
		static void getMetaData(PxSerialStream& stream)
		{
			...
			// mMap
			DEFINE_MD_EXTRA_DATA_ARRAY(ShadowBitMap, PxU32, mWordCount, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP, MdFlags::eMASK_MSB_COUNT)
		}
	};
...
static void getMetaData_PtrTable(PxSerialStream& stream)
{
	...
	// mList
	DEFINE_MD_EXTRA_DATA_ITEMS(PtrTable, void, mBufferUsed, mCount, MdFlags::eFLIP_CONTROL|MdFlags::ePTR, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP)
}
