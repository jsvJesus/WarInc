...
namespace Sq
{
	...
	public:
		...
		// queries
						bool							raycastAny				(const PxVec3& rayOrigin, const PxVec3& rayDir, PxReal rayLength, PxSceneQueryHit& hit, PxU32 filterFlags, PxSceneQueryFilterCallback* filterCall, const PxFilterData* filterData, PxBatchQueryPreFilterShader preFilterShader, PxBatchQueryPostFilterShader postFilterShader, const void* constBlock, PxU32 cBlockSize, PxClientID queryClient, SceneQueryShapeData* cache, bool isBatchQuery) const;
						...
						PxI32							overlapSphereObjects	(const Gu::Sphere& worldSphere, bool multipleOverlaps, PxU32 nbObjects, PxShape** objects, void* userData, PxU32 filterFlags, PxSceneQueryFilterCallback* filterCall, const PxFilterData* filterData, PxBatchQueryPreFilterShader preFilterShader, PxBatchQueryPostFilterShader postFilterShader, const void* constBlock, PxU32 cBlockSize, PxClientID queryClient, bool isBatchQuery) const;
		...
		// is create/release SweepCache needed?
						...
						void							updateCache(ObjectCache& cache,
																	...
																	bool updateStatic, bool updateDynamic) const;
						void							updateCache(ObjectCache& cache,
																	const PxVec3& worldBox_Center, const PxVec3& worldBox_Extents, const PxQuat& worldBox_Rot,
	...
	public:
		...
		PX_FORCE_INLINE	shdfnd::Mutex&					getSceneQueryLock()				const	{ return mSceneQueryLock;					}
	...
	private:
						...
						// mutable because modified from logically const scene query methods
						mutable Ps::Array<NpShape*>		mDirtyShapes;
		...
		mutable			shdfnd::Mutex					mSceneQueryLock;
		...
		PX_FORCE_INLINE	bool							UpdateObject(Prunable& object) const
														{
		...
		// Queries dispatcher
						void							cull(PruningTemps& temps, CulledObjects& objects, const Gu::Plane* planes, PxU32 nb_planes, PxU32 flags) const;
						void							stab(StabCallback callback, void* user_data, const PxVec3& orig, const PxVec3& dir, float max_dist, PxU32 flags) const;
						void							overlap(ReportPrunablesCallback cb, void* userData, const Gu::Sphere& sphere, PxU32 flags) const;
						void							overlap(ReportPrunablesCallback cb, void* userData, const PxBounds3& box, PxU32 flags) const;
						void							overlap(ReportPrunablesCallback cb, void* userData, const Gu::Box& box, PxU32 flags) const;
						void							overlap(ReportPrunablesCallback cb, void* userData, const Gu::Capsule& capsule, PxU32 flags) const;
						...
						PxI32							runLinearSweepCB(const SweptVolume& volume, const PxSweepHit& blockingHit, const Gu::Box& querySweptBox, const PxVec3& unitDir, 
																	...
																	PxClientID queryClient, const SceneQueryShapeData* cache, PxSceneQueryFlags hintFlags, bool isBatchQuery) const;
	};
