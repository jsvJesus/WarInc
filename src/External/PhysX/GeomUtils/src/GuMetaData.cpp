...
// 28 bytes
	...
	DEFINE_MD_EXTRA_DATA_ARRAY(BigConvexData, PxU8, mData.mNbSamples, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP, 0)
	DEFINE_MD_EXTRA_DATA_ARRAY(BigConvexData, PxU8, mData.mNbSamples, 0, 0)

	// mData.mValencies
	// PT: same here, we must only align the first array
	DEFINE_MD_EXTRA_DATA_ARRAY(BigConvexData, Valency, mData.mNbVerts, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP, 0)
...
// 136 bytes
	...
	// chull.mPolygons (Gu::HullPolygonData, PxVec3, PxU8*2, PxU8)
	// PT: we only align the first array since the other ones are contained within it
	DEFINE_MD_EXTRA_DATA_ARRAY(Gu::ConvexMesh, HullPolygonData,	chull.mNbPolygons,		PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP, 0)
	...
	// bigConvexData
	DEFINE_MD_EXTRA_DATA_ITEM(Gu::ConvexMesh, BigConvexData, bigConvexData, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP)
}
...
#else
	DEFINE_MD_EXTRA_DATA_ARRAY(HeightField, PxHeightFieldSample, mNbSamples, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP, 0)	// PT: ### try to remove mNbSamples later
#endif
}
...
// 128 bytes
	...
	// mTriangles
	DEFINE_MD_EXTRA_DATA_ARRAY(HybridModel, LeafTriangles, mNbLeaves, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP, MdFlags::eMASK_MSB_COUNT)
	// mIndices
	DEFINE_MD_EXTRA_DATA_ITEMS(HybridModel, PxU32, mIndices, mNbPrimitives, 0, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP)
}
...
// 224 => 208 => 192 bytes
	...
	// mVertices
	DEFINE_MD_EXTRA_DATA_ITEMS(InternalTriangleMeshData, PxVec3, mVertices, mNumVertices, 0, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP)
	...
	DEFINE_MD_EXTRA_DATA_ITEMS(InternalTriangleMeshData, PxU16, m16BitIndices, mNumTriangles, 0, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP)
	DEFINE_MD_EXTRA_DATA_ITEMS(InternalTriangleMeshData, PxU16, m16BitIndices, mNumTriangles, 0, 0)
	DEFINE_MD_EXTRA_DATA_ITEMS(InternalTriangleMeshData, PxU16, m16BitIndices, mNumTriangles, 0, 0)
	DEFINE_MD_EXTRA_DATA_ITEMS(InternalTriangleMeshData, PxU32, m16BitIndices, mNumTriangles, MdFlags::eFLIP_CONTROL, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP)
	DEFINE_MD_EXTRA_DATA_ITEMS(InternalTriangleMeshData, PxU32, m16BitIndices, mNumTriangles, MdFlags::eFLIP_CONTROL, 0)
	DEFINE_MD_EXTRA_DATA_ITEMS(InternalTriangleMeshData, PxU32, m16BitIndices, mNumTriangles, MdFlags::eFLIP_CONTROL, 0)

	// mExtraTrigData
	DEFINE_MD_EXTRA_DATA_ITEMS(InternalTriangleMeshData, PxU8, mExtraTrigData, mNumTriangles, 0, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP)
}
...
// 256 => 240 bytes
	...
	// mMaterialIndices
	DEFINE_MD_EXTRA_DATA_ITEMS(InternalTriangleMesh, PxU16, mMaterialIndices, mData.mNumTriangles, 0, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP)

	// mFaceRemap
	DEFINE_MD_EXTRA_DATA_ITEMS(InternalTriangleMesh, PxU32, mFaceRemap, mData.mNumTriangles, 0, PX_SERIAL_DEFAULT_ALIGN_EXTRA_DATA_WIP)
}
