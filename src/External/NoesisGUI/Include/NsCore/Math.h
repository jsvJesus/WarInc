...
constexpr float Pi = 3.14159265358979323846264338327950288419716939937511f;
constexpr float OneOverPi = 1.0f / Pi;
constexpr float E = 2.71828182845904523536028747135266249775724709369996f;
constexpr float TwoPi = 2.0f * Pi;
constexpr float FourPi = 4.0f * Pi;
constexpr float HalfPi = Pi / 2.0f;
constexpr float SqrtPi = 1.77245385090551602729816748334114518279754945612239f;
...
/// Tests if a float is NaN
bool IsNaN(float val);

/// Tests if a double is NaN
bool IsNaN(double val);

/// Tests if a float is infinity (positive or negative)
bool IsInfinity(float val);

/// Tests if a double is infinity (positive or negative)
bool IsInfinity(double val);

/// Tests if a float is positive infinity
bool IsPositiveInfinity(float val);

/// Tests if a double is positive infinity
bool IsPositiveInfinity(double val);

/// Tests if a float is negative infinity
bool IsNegativeInfinity(float val);

/// Tests if a double is negative infinity
bool IsNegativeInfinity(double val);

/// Test if a float is finite (neither infinite nor NaN)
bool IsFinite(float val);

/// Test if a double is finite (neither infinite nor NaN)
