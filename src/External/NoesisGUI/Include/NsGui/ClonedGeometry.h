...
protected:
    ...
    bool FillContainsOverride(const Point& p, Transform* transform) const override;
    bool StrokeContainsOverride(Pen* pen, const Point& p, Transform* transform) const override;
    //@}
