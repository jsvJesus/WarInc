...
protected:
    ...
    /// From Geometry
    //@{
    Rect GetRenderBoundsOverride(Pen* pen, Transform* transform) const;
    bool FillContainsOverride(const Point& point, Transform* transform) const;
    bool StrokeContainsOverride(Pen* pen, const Point& point, Transform* transform) const;
    //@}
