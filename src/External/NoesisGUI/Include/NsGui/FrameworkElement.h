...
public:
    ...
    /// the specified name
    void SetResourceReference(const DependencyProperty* dp, const char* name);
...
protected:
    ...
    ProviderValue GetNonCachedProviderValue(const DependencyProperty* dp,
        uint32_t sizeOfT) const override;
...
private:
  ...
  #if NS_XAML_RELOAD_ENABLED
    friend class XamlContext;
    void ForceTemplate(FrameworkTemplate* newTemplate);
  #endif
