...
public:
    ...
    /// \prop
    BaseComponent* GetResolvedSource() const;
...
private:
    ...
    bool IsSelf() const;
    bool IsSourceReadOnly(Symbol& propOwner, Symbol& propName) const;
    ...
    void OnTargetDelayUnloaded(BaseComponent*, const RoutedEventArgs&);

    void OnTargetObjectDestroyed(DependencyObject* object);
