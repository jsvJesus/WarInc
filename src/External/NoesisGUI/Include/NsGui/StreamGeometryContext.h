...
public:
    ...
    /// Overrides the isClosed flag for the current figure
    void SetIsClosed(bool isClosed) const;
...
private:
    ...
    mutable Vector<uint32_t, 512> mCommands;
