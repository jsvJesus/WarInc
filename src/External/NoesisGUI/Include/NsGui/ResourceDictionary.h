...
private:
    ...
    void OnMergedDictionariesCollectionChanged(BaseComponent* sender,
        const NotifyCollectionChangedEventArgs& args);
    void OnAddMergedDictionary(ResourceDictionary* dict, bool registerChanges);
    void OnRemoveMergedDictionary(ResourceDictionary* dict, bool unregisterChanges);
    void OnRemoveMergedDictionaryForMerged(ResourceDictionary* dict, bool unregisterChanges);

    void UnregisterMergedChanges();
    void OnMergedDictionaryChanged(BaseComponent* s, const NotifyDictionaryChangedEventArgs& e);
