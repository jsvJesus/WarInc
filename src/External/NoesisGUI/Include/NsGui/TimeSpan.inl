...
{
    mTicks = static_cast<int64_t>((float)mTicks * value);
    return *this;
}
...
{
    return TimeSpan(static_cast<int64_t>((float)t.GetTicks() * value));
}

////////////////////////////////////////////////////////////////////////////////////////////////////
inline TimeSpan operator*(float value, const TimeSpan& t)
{
    return TimeSpan(static_cast<int64_t>(value * (float)t.GetTicks()));
}
