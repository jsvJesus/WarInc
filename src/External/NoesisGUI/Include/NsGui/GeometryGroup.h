...
///
/// A GeometryGroup creates a composite geometry from any number of geometry objects. GeometryGroup
/// uses the *FillRule* property to specify how its geometry objects are combined.
///
