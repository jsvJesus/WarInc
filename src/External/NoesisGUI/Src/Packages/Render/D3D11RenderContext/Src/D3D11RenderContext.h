...
// Enables DirectComposition for per-pixel desktop alpha
#define USE_DIRECT_COMPOSITION 0
...
private:
    ...
    ID3DUserDefinedAnnotation* mGroupMarker = nullptr;
    ...
    uint32_t mWidth;
    uint32_t mHeight;
    IDCompositionDevice* mCompositionDevice = nullptr;
    IDCompositionTarget* mCompositionTarget = nullptr;
  #endif
