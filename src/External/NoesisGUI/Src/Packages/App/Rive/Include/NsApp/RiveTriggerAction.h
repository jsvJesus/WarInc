...
///          <noesis:RiveTriggerAction TargetName="rive" TriggerPath="ReloadArtboard" TriggerName="Start"/>
///        </b:EventTrigger>
///      </b:Interaction.Triggers>
///    </Button>
///  </Grid>
...
public:
    ...
    //@{
    const char* GetTriggerPath() const;
    void SetTriggerPath(const char* path);
    //@}
...
public:
    static const Noesis::DependencyProperty* TriggerPathProperty;
