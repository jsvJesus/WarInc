...
///      <noesis:RiveRun RunPath="DetailsArtboard" RunName="Age" RunText="{Binding Player.Age}"/>
///    </noesis:RiveControl.Runs>
///  </noesis:RiveControl>
////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    typedef void TextChangedT(const char* path, const char* name, const char* text);
    Noesis::Delegate<TextChangedT>& TextChanged();

public:
    /// Dependency properties
    //@{
    static const Noesis::DependencyProperty* RunPathProperty;
