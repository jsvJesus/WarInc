...
////////////////////////////////////////////////////////////////////////////////////////////////////
const char* RiveRun::GetRunPath() const
{
    return Noesis::DependencyObject::GetValue<Noesis::String>(RunPathProperty).Str();
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void RiveRun::SetRunPath(const char* path)
{
    Noesis::DependencyObject::SetValue<Noesis::String>(RunPathProperty, path);
}
...
NS_IMPLEMENT_REFLECTION(RiveRun, "NoesisGUIExtensions.RiveRun")
{
    ...
    {
        RiveRun* run = Noesis::DynamicCast<RiveRun*>(d);
        if (run != nullptr)
        {
            const Noesis::String& str = e.NewValue<Noesis::String>();
            run->mTextChanged(run->GetRunPath(), run->GetRunName(), str.Str());
        }
    };

    Noesis::UIElementData* data = NsMeta<Noesis::UIElementData>(Noesis::TypeOf<SelfClass>());
    data->RegisterProperty<Noesis::String>(RunPathProperty, "RunPath",
...
////////////////////////////////////////////////////////////////////////////////////////////////////
const Noesis::DependencyProperty* RiveRun::RunPathProperty;
