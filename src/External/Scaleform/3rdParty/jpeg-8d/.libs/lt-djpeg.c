...
/* ./.libs/lt-djpeg.c - temporary wrapper executable for .libs/djpeg
...
const char * TARGET_PROGRAM_NAME = "djpeg"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# djpeg - temporary wrapper script for .libs/djpeg\n", f);
  ...
  fputs ("    echo \"djpeg:djpeg:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"djpeg:djpeg:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"djpeg:djpeg:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
