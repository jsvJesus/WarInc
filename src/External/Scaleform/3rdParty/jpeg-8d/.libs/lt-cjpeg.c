...
/* ./.libs/lt-cjpeg.c - temporary wrapper executable for .libs/cjpeg
...
const char * TARGET_PROGRAM_NAME = "cjpeg"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# cjpeg - temporary wrapper script for .libs/cjpeg\n", f);
  ...
  fputs ("    echo \"cjpeg:cjpeg:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"cjpeg:cjpeg:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"cjpeg:cjpeg:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
