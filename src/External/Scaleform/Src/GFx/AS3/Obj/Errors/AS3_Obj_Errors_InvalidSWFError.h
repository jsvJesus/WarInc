...
Filename    :   AS3_Obj_Errors_InvalidSWFError.h
Content     :   
Created     :   Jan, 2010
...
#ifndef INC_AS3_Obj_Errors_InvalidSWFError_H
#define INC_AS3_Obj_Errors_InvalidSWFError_H
...
namespace fl_errors
{
    extern const TypeInfo InvalidSWFErrorTI;
