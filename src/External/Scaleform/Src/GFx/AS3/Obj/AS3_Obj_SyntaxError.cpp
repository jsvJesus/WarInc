...
{
    SyntaxError::SyntaxError(VM& vm)
    : Traits(vm, AS3::fl::SyntaxErrorCI)
    {
//##protect##"ClassTraits::SyntaxError::SyntaxError()"
//##protect##"ClassTraits::SyntaxError::SyntaxError()"
        MemoryHeap* mh = vm.GetMemoryHeap();

        Pickable<InstanceTraits::Traits> it(SF_HEAP_NEW_ID(mh, StatMV_VM_ITraits_Mem) InstanceTraits::fl::Error(vm, AS3::fl::SyntaxErrorCI));
    ...
    {
        return Pickable<Traits>(SF_HEAP_NEW_ID(vm.GetMemoryHeap(), StatMV_VM_CTraits_Mem) SyntaxError(vm));
    }
