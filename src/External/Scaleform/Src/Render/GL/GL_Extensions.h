...
class Extensions
{
    ...
    PFNGLDRAWARRAYSINSTANCEDPROC                    p_glDrawArraysInstanced;
...
public:
    ...
    void glDrawArraysInstanced(GLenum a0, GLint a1, GLsizei a2, GLsizei a3)
    {
        ScopedGLErrorCheck check(__FUNCTION__);
        p_glDrawArraysInstanced(a0, a1, a2, a3);
    }
