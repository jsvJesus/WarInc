...
"  fcolor.a *= factor.a;\n"
"// E Mul\n"
"  fcolor = mix(vec4(1.0), fcolor, vec4(fcolor.a));\n"
"\n"
"  gl_FragColor = fcolor;\n"
"}";
...
"      fcolor = mix(scolor, base, fcolor.a) * base.a;\n"
"  // E Knockout\n"
"  fcolor -= base;\n"
"// E cxformac\n"
"  fcolor = (fcolor * vec4(cxmul.rgb,1.0)) * cxmul.a + cxadd * fcolor.a;\n"
"\n"
"  gl_FragColor = fcolor;\n"
"}";
...
"// E InnerShadow\n"
"  vec4 base = texture2D(srctex, tc * srctexscale);\n"
"      fcolor.ar = clamp((1.0 - fcolor.ar) - (1.0 - fcolor.ra) * 0.5, 0.0, 1.0);\n"
...
" lowp vec4 fcolor;\n"
"// E YUV\n"
"  lowp float c0 = float((texture2D(tex_y, tc).a - 16./255.) * 1.164);\n"
"  lowp float U0 = float(texture2D(tex_u, tc).a - 128./255.);\n"
"  lowp float V0 = float(texture2D(tex_v, tc).a - 128./255.);\n"
