...
class FxShippingPlayer : public App<FxRenderThread>, public ExternalInterface
{
public:
    typedef App<FxRenderThread> BaseClass;

    static FxShippingPlayer*    pApp;
