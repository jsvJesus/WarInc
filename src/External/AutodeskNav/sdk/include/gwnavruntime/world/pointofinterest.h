...
public: // internal
	...
	// Updates the SpatializedPoint to Databases linkage.
...
KY_INLINE void PointOfInterest::UpdateNavFloorCollections()                { m_spatializedPoint->UpdateNavFloorCollections();                         }
