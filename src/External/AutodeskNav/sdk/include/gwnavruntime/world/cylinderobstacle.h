...
public: // internal
	...
	// Updates the SpatializedCylinder to Databases linkage.
...
KY_INLINE void CylinderObstacle::UpdateNavFloorCollections()
{
	if (m_tagVolumeTrigger.GetIntegrationStatus() != TagVolume::IntegrationStatus_Integrated)
		m_spatializedCylinder.UpdateNavFloorCollections();
}

KY_INLINE void CylinderObstacle::ComputeNewSpatialization()
{
