...
public:
	...
	/// algorithm results.
	void SetCurrentVisualDebugLOD(VisualDebugLOD lod) { m_currentVisualDebugLOD = lod; }
...
public: // internal
	...
	void SendShapeWhenMaxLevelOfDetail(VisualDebugServer& server, const Vec3f& shapePosition);
