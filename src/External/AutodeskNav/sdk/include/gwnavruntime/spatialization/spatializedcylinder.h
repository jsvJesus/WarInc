...
public:
	...
	void InitFromBot(DatabaseBinding* databaseBinding, Bot* bot, KyFloat32 radius, KyFloat32 height);
	void InitFromCylinderObstacle(DatabaseBinding* databaseBinding, CylinderObstacle* cylinderObstacle, KyFloat32 radius, KyFloat32 height);
	void InitFromBoxObstacle(DatabaseBinding* databaseBinding, BoxObstacle* boxObstacle, KyUInt32 cylinderIndex, KyFloat32 radius, KyFloat32 height);
...
public:
	...
	void UpdateSpatialization(const Vec3f& currentPosition);
...
KY_INLINE SpatializedCylinder::SpatializedCylinder() : m_velocity(Vec3f::Zero()) , m_radius(0.0f) , m_height(0.0f) {}
...
KY_INLINE KyFloat32               SpatializedCylinder::GetHeight()                           const { return m_height;                                        }
...
KY_INLINE void SpatializedCylinder::SetHeight(KyFloat32 height)                        { m_height = height;                                         }
...
KY_INLINE void SpatializedCylinder::UpdateSpatialization(const Vec3f& currentPosition) { m_spatializedPoint->UpdateSpatialization(currentPosition); }
KY_INLINE void SpatializedCylinder::UpdateNavFloorCollections()                        { m_spatializedPoint->UpdateNavFloorCollections();           }
...
KY_INLINE void SpatializedCylinderInitConfig::InitFromBot(DatabaseBinding* databaseBinding, Bot* bot, KyFloat32 radius, KyFloat32 height)
{
	m_spatializedPointInitConfig.InitFromBot(databaseBinding, bot);
	m_radius = radius;
	m_height = height;
}

KY_INLINE void SpatializedCylinderInitConfig::InitFromCylinderObstacle(DatabaseBinding* databaseBinding, CylinderObstacle* cylinderObstacle, KyFloat32 radius, KyFloat32 height)
{
	m_spatializedPointInitConfig.InitFromCylinderObstacle(databaseBinding, cylinderObstacle);
	m_radius = radius;
	m_height = height;
}

KY_INLINE void SpatializedCylinderInitConfig::InitFromBoxObstacle(DatabaseBinding* databaseBinding, BoxObstacle* boxObstacle, KyUInt32 cylinderIndex, KyFloat32 radius, KyFloat32 height)
{
	m_spatializedPointInitConfig.InitFromBoxObstacle(databaseBinding, boxObstacle, cylinderIndex);
	m_radius = radius;
	m_height = height;
}
