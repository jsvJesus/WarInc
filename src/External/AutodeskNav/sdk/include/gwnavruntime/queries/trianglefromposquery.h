...
public:
	...
	/// Call this method after Initialize(), during which member #m_queryType is set to its default value. 
...
private:
	...
	/// Updated during processing to indicate the difference in altitude between #m_inputPos3f and the projected
	/// altitude of #m_inputPos3f on the triangle stored in #m_resultTrianglePtr. 
