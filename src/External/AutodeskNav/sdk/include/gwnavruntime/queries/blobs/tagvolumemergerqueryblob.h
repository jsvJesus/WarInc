...
#ifndef Navigation_TagVolumeMergerQueryBlob_H
#define Navigation_TagVolumeMergerQueryBlob_H

#include "gwnavruntime/queries/blobs/queryblobcategory.h"
#include "gwnavruntime/queries/tagvolumemergerquery.h"
...
class TagVolumeMergerQueryBlob
{
	KY_DEFINE_NEW_DELETE_OPERATORS(Stat_Default_Mem)
	KY_ROOT_BLOB_CLASS(Query, TagVolumeMergerQueryBlob, 0)
public:
	TagVolumeMergerQueryBlob() {}
...
inline void SwapEndianness(Endianness::Target e, TagVolumeMergerQueryBlob& self)
{
...
class TagVolumeMergerQueryBlobBuilder : public BaseBlobBuilder<TagVolumeMergerQueryBlob>
{
public:
	TagVolumeMergerQueryBlobBuilder(TagVolumeMergerQuery* query) { m_query = query; }
...
#endif // Navigation_TagVolumeMergerQueryBlob_H
