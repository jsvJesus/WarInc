...
protected: // internal
	...
	void Initialize(Database* database, const Vec3f& startPos, const Box3f& extentBox);
	...
	// NavFloor -> Neihgbour NavFloors
	KyResult TraverseNeighbourNavFloors(SpatializedPointCollectorContext* traversalContext, const NavFloorRawPtr& navFloorRawPtr);

	// NavGraphEdge -> Neihgbour NavFloor
	KyResult TraverseNeighbourNavFloors(SpatializedPointCollectorContext* traversalContext, const NavGraphEdgeRawPtr& navGraphEdgeRawPtr);

	// NavFloor -> Neihgbour navGraphEdges
	KyResult TraverseNeighbourNavGraphEdges(SpatializedPointCollectorContext* traversalContext, const NavFloorRawPtr& navFloorRawPtr);

	// NavGraphEdge -> Neihgbour navGraphEdges
	KyResult TraverseNeighbourNavGraphEdges(SpatializedPointCollectorContext* traversalContext, const NavGraphEdgeRawPtr& navGraphEdgeRawPtr);

	KyResult ProcessNeihgbourNavFloor(SpatializedPointCollectorContext* traversalContext, const NavFloorRawPtr& navFloorRawPtr);
	KyResult ProcessNeihgbourNavGraphEdge(SpatializedPointCollectorContext* traversalContext, const NavGraphEdgeRawPtr& navGraphEdgeRawPtr);
