...
public:
	...
	void DoSendVisualDebug(VisualDebugServer& visualDebugServer, VisualDebugSendChangeEvent changeEvent);
...
protected:
	...
	QueryQueueStats m_stats;                                          ///< Remenber statistics of this QueryQueue. For Visual Debug.
