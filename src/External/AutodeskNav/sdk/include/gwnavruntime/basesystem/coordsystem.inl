...
{
	navigationMatrix.m_rows[0][0] = clientMatrix.m_rows[m_navigationX_idx][m_navigationX_idx];
	navigationMatrix.m_rows[0][1] = clientMatrix.m_rows[m_navigationX_idx][m_navigationY_idx] * m_navigationX_sign * m_navigationY_sign;
	navigationMatrix.m_rows[0][2] = clientMatrix.m_rows[m_navigationX_idx][m_navigationZ_idx] * m_navigationX_sign * m_navigationZ_sign;

	navigationMatrix.m_rows[1][0] = clientMatrix.m_rows[m_navigationY_idx][m_navigationX_idx] * m_navigationY_sign * m_navigationX_sign;
	navigationMatrix.m_rows[1][1] = clientMatrix.m_rows[m_navigationY_idx][m_navigationY_idx];
	navigationMatrix.m_rows[1][2] = clientMatrix.m_rows[m_navigationY_idx][m_navigationZ_idx] * m_navigationY_sign * m_navigationZ_sign;

	navigationMatrix.m_rows[2][0] = clientMatrix.m_rows[m_navigationZ_idx][m_navigationX_idx] * m_navigationZ_sign * m_navigationX_sign;
	navigationMatrix.m_rows[2][1] = clientMatrix.m_rows[m_navigationZ_idx][m_navigationY_idx] * m_navigationZ_sign * m_navigationY_sign;
	navigationMatrix.m_rows[2][2] = clientMatrix.m_rows[m_navigationZ_idx][m_navigationZ_idx];
}
inline void CoordSystem::NavigationToClient_Matrix(const Matrix3x3f& navigationMatrix, Matrix3x3f& clientMatrix) const
{
	clientMatrix.m_rows[m_navigationX_idx][m_navigationX_idx] = navigationMatrix.m_rows[0][0];
	clientMatrix.m_rows[m_navigationX_idx][m_navigationY_idx] = navigationMatrix.m_rows[0][1] * m_navigationX_sign * m_navigationY_sign;
	clientMatrix.m_rows[m_navigationX_idx][m_navigationZ_idx] = navigationMatrix.m_rows[0][2] * m_navigationX_sign * m_navigationZ_sign;

	clientMatrix.m_rows[m_navigationY_idx][m_navigationX_idx] = navigationMatrix.m_rows[1][0] * m_navigationY_sign * m_navigationX_sign;
	clientMatrix.m_rows[m_navigationY_idx][m_navigationY_idx] = navigationMatrix.m_rows[1][1];
	clientMatrix.m_rows[m_navigationY_idx][m_navigationZ_idx] = navigationMatrix.m_rows[1][2] * m_navigationY_sign * m_navigationZ_sign;

	clientMatrix.m_rows[m_navigationZ_idx][m_navigationX_idx] = navigationMatrix.m_rows[2][0] * m_navigationZ_sign * m_navigationX_sign;
	clientMatrix.m_rows[m_navigationZ_idx][m_navigationY_idx] = navigationMatrix.m_rows[2][1] * m_navigationZ_sign * m_navigationY_sign;
	clientMatrix.m_rows[m_navigationZ_idx][m_navigationZ_idx] = navigationMatrix.m_rows[2][2];
}
...
inline void CoordSystem::SetClientUpValue(Vec3f& clientPos, float upValue) const
{
	clientPos[m_navigationZ_idx] = NavigationToClient_Dist(m_navigationZ_sign * upValue);
}
