...
public:
	...
	/// Converts a Tranform from the game engine coordinate system to the Gameware Navigation coordinate system.
	/// \param clientTranform			The Tranform to convert, expressed in the game engine coordinate system.
	/// \param[out] navigationTranform	Used to store the converted Tranform, expressed in the Gameware Navigation coordinate system. 
	void ClientToNavigation_Tranform(const Transform& clientTranform, Transform& navigationTranform) const;

	/// Converts a Tranform from the Gameware Navigation coordinate system to the game engine coordinate system.
	/// \param navigationTranform		The Tranform to convert, expressed in the Gameware Navigation coordinate system.
	/// \param[out] clientTranform		Used to store the converted Tranform, expressed in the game engine coordinate system. 
	...
	/*!	Set the up value of the given position in client coordinate system.
		\param clientPos				The position for which the up must be set, expressed in the game engine coordinate system..
		\param upValue					The up value. */
	void SetClientUpValue(Vec3f& clientPos, float upValue) const;
