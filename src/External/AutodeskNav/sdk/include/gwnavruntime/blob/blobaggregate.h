...
#include "gwnavruntime/visualdebug/messages/rawdatablob.h"
...
class BlobAggregate : public RefCountBase<IBlobTypeDescriptor, MemStat_Blob>
{
public:
...
private:
	...
	Ptr<BlobHandler<VersionBlob> > m_versionBlobHandler; // This blob is stored out of m_collections
