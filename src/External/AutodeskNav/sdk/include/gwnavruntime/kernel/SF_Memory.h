...
public:
    ...
    static void* KY_STDCALL Alloc(UPInt size)                                       { return pGlobalHeap->Alloc(size); }
    static void* KY_STDCALL Alloc(UPInt size, UPInt align)                          { return pGlobalHeap->Alloc(size, align); }
    static void* KY_STDCALL Alloc(UPInt size, const AllocInfo& info)                { return pGlobalHeap->Alloc(size, &info); }
    static void* KY_STDCALL Alloc(UPInt size, UPInt align, const AllocInfo& info)   { return pGlobalHeap->Alloc(size, align, &info); }

    // Allocate while automatically identifying heap and allocation id based on the specified address.
    static void* KY_STDCALL AllocAutoHeap(const void *p, UPInt size)                                     { return pGlobalHeap->AllocAutoHeap(p, size); }
    static void* KY_STDCALL AllocAutoHeap(const void *p, UPInt size, UPInt align)                        { return pGlobalHeap->AllocAutoHeap(p, size, align); }
    static void* KY_STDCALL AllocAutoHeap(const void *p, UPInt size, const AllocInfo& info)              { return pGlobalHeap->AllocAutoHeap(p, size, &info); }
    static void* KY_STDCALL AllocAutoHeap(const void *p, UPInt size, UPInt align, const AllocInfo& info) { return pGlobalHeap->AllocAutoHeap(p, size, align, &info); }
    ...
    static void* KY_STDCALL AllocInHeap(MemoryHeap* heap, UPInt size)                                       { return heap->Alloc(size); }
    static void* KY_STDCALL AllocInHeap(MemoryHeap* heap, UPInt size, UPInt align)                          { return heap->Alloc(size, align); }
    static void* KY_STDCALL AllocInHeap(MemoryHeap* heap, UPInt size, const AllocInfo& info)                { return heap->Alloc(size, &info); }
    static void* KY_STDCALL AllocInHeap(MemoryHeap* heap, UPInt size, UPInt align, const AllocInfo& info)   { return heap->Alloc(size, align, &info); }
    ...
    static void* KY_STDCALL Realloc(void *p, UPInt newSize)                         { return pGlobalHeap->Realloc(p, newSize); }
    static void* KY_STDCALL ReallocAutoHeap(void *p, UPInt newSize)                 { return pGlobalHeap->ReallocAutoHeap(p, newSize); }
    static void* KY_STDCALL ReallocInHeap(MemoryHeap* heap, void *p, UPInt newSize) { return heap->Realloc(p, newSize); }

    // Free allocated/reallocated block
    static void         KY_STDCALL Free(void *p)                    { return pGlobalHeap->Free(p); }
