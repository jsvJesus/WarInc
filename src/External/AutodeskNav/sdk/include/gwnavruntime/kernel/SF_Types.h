...
# define KY_OS_PS3
# define KY_OS_STRING         "PS3 PPU"
#elif defined(__ORBIS__)
# define KY_OS_ORBIS
# define KY_OS_STRING         "Orbis"
#elif defined(RVL)
# define KY_OS_WII
...
#else
# define KY_OS_OTHER
# define KY_OS_STRING         "Unknown Platform"
#endif
 
#if defined(_DURANGO)
# define KY_OS_WINMETRO
# undef KY_OS_STRING
# define KY_OS_STRING         "WinMetro"
#endif
...
#  define KY_CPU_X86
#elif defined(__powerpc64__) || defined(KY_OS_PS3) || defined(KY_OS_XBOX360) || defined(KY_OS_WII)
#  define KY_CPU_PPC64
...
#       if defined(__cplusplus_cli)
        #define KY_DEBUG_BREAK do { __debugbreak(); } while(0)
#   elif defined(KY_CC_GNU)
        #define KY_DEBUG_BREAK do { KY_ASM("int $3\n\t"); } while(0)
#       else
        #define KY_DEBUG_BREAK do { KY_ASM int 3 } while (0)
#       endif
#   else
    #define KY_DEBUG_BREAK     do { __debugbreak(); } while(0)
#   endif
// Xbox360 specific debugging
    ...
    #define KY_DEBUG_BREAK         DebugBreak()
    ...
    #define KY_DEBUG_BREAK     do { __builtin_trap(); } while(0)
#elif defined(KY_CPU_X86)
    #define KY_DEBUG_BREAK     do { KY_ASM("int $3\n\t"); } while(0)
#elif defined(KY_OS_3DS)
    #include <nn/dbg.h>
    #define KY_DEBUG_BREAK     do { nn::dbg::Break(nn::dbg::BREAK_REASON_USER); } while(0)
#elif defined(KY_OS_WIIU)
    #define KY_DEBUG_BREAK     do { OSDebug(); } while(0)
#else
    #define KY_DEBUG_BREAK     do { *((int *) 0) = 1; } while(0)
#endif

// This will cause compiler breakpoint
#ifndef KY_ASSERT
    #define KY_ASSERT(p)       do { if (!(p))  { KY_DEBUG_BREAK; } } while(0)
#endif
...
#define KY_COMPILER_ASSERTG(x, f)   void dummy_function_##f()KY_COMPILER_ASSERT(x)
...
#  define KY_TODO( x ) KY_COMPILE_TIME_MESSAGE("[TODO]:" x)
# else
#  define KY_TODO( x ) 
