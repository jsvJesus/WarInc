...
public:
	...
	KyUInt32              GetNeihbourVertexCount() const; ///< Returns the number of outgoing edges (equal to the number of neighbors) of this vertex. \pre This object must be valid. Its validity is not checked.
...
KY_INLINE KyUInt32              NavGraphVertexRawPtr::GetNeihbourVertexCount() const { return GetNavGraphVertex().GetNeihbourVertexCount();      }
