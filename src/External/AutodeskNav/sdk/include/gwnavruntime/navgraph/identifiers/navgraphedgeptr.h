...
public:
	...
	NavGraphEdgePtr(const NavGraphVertexPtr& navGraphVertexPtr, KyUInt32 neighbourIndex);
...
KY_INLINE NavGraphEdgePtr::NavGraphEdgePtr(const NavGraphVertexPtr& navGraphVertexPtr, KyUInt32 neighbourIndex) :
	m_navGraphPtr(navGraphVertexPtr.m_navGraphPtr), m_edgeSmartIdx(navGraphVertexPtr.GetNavGraphVertexIdx(), neighbourIndex) {}
...
KY_INLINE KyUInt32              NavGraphEdgePtr::GetEdgeNumberAroundStartVertex() const { return m_edgeSmartIdx.GetNeighbourVertexIdx();                        }
...
KY_INLINE NavGraphVertexPtr     NavGraphEdgePtr::GetStartNavGraphVertexPtr()      const { return NavGraphVertexPtr(GetRawPtr().GetStartNavGraphVertexRawPtr()); }
KY_INLINE NavGraphVertexPtr     NavGraphEdgePtr::GetEndNavGraphVertexPtr()        const { return NavGraphVertexPtr(GetRawPtr().GetEndNavGraphVertexRawPtr());   }
