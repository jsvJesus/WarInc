...
public: 
	...
	KyUInt32 ComputeVertexCount()
	{
		KyUInt32 count = 0;
		BlobRef<NavGraphBlob>* navGraphs = m_navGraphs.GetValues();
	...
	KyUInt32 ComputeVertexToConnectCount()
	{
		KyUInt32 count = 0;
		BlobRef<NavGraphBlob>* navGraphs = m_navGraphs.GetValues();
		for (KyUInt32 graphIdx = 0; graphIdx < m_navGraphs.GetCount(); ++graphIdx)
