...
public:
	...
	/// Creates a vector with provided Vec2f horizontal coordinates and 0.0 altitude.
	/// \param v			The size of the vector along the X and Y axes respectively; Z size will be set to 0.0f.
	...
	/// \param coords		An array of three floating-point numbers that contains the size of the
	/// 					vector along the X, Y and Z axes respectively. 
	KY_INLINE void Set(KyFloat32* coords) { x = coords[0]; y = coords[1]; z = coords[2]; }
...
/// Returns the normalized horizontal vector on the right of v. Ifv is vertical, this return Vec3f::Zero().  
