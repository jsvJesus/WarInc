...
/// EachDatabase object maintains and provides access to an instance of this class
...
public:
	...
	/// \param[out] cellPos    The position of theNavCell responsible forpos. 
...
public: // internal
	...
	KyFloat32 m_integerPrecisionInv; ///< For internal use. Do not modify. 
	KyFloat32 m_pixelSize;           ///< For internal use. Do not modify. 
	KyInt32 m_cellSizeInPixel;       ///< The number of raster pixels in the length and width of each cell. Do not modify. 
	KyInt32 m_cellSizeInCoord;       ///< The number of integer steps in the length and width of each cell. Do not modify. 
};
