...
#ifndef GwNavGen_SquarePartition_H
#define GwNavGen_SquarePartition_H

#include "gwnavruntime/navmesh/navmeshtypes.h"
#include "gwnavruntime/math/squarepartitionutils.h"
...
public:
	Coord m_pixelSize; // in integer coordinates
	Coord m_cellSize;  // in integer coordinates
	PixelCoord m_nbPixelsOnCellSide;

	Coord m_coordEnlargement; // in integer coordinates
	Coord m_pixelEnlargement; // in integer coordinates
};
