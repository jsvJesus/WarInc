...
public:
	static KY_INLINE KyUInt32 GetNumberOfWordsForTriangleLinkStatus(KyUInt32 numberOfTriangle) { return BitFieldBase::GetWordsCount(numberOfTriangle); }
...
KY_INLINE bool NavFloorToNavGraphLinks::IsTriangleLinkedToGraph(NavTriangleIdx navTriangleIdx) const { return BitFieldBase::IsBitSet(GetBitFieldWords(), navTriangleIdx); }
KY_INLINE void NavFloorToNavGraphLinks::SetTriangleAsLinked(NavTriangleIdx navTriangleIdx) { BitFieldBase::SetBit(GetBitFieldWords(), navTriangleIdx); }
KY_INLINE void NavFloorToNavGraphLinks::SetTriangleAsNotLinked(NavTriangleIdx navTriangleIdx) { BitFieldBase::UnsetBit(GetBitFieldWords(), navTriangleIdx); }
