...
KY_INLINE NavFloorBlob::NavFloorBlob() : m_boundariesType(0) {}
...
KY_INLINE FloorBoundariesType NavFloorBlob::GetFloorBoundariesType() const { return (FloorBoundariesType)m_boundariesType; }
