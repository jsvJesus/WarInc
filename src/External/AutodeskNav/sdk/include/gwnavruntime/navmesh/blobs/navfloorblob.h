...
public:
	...
	FloorBoundariesType       GetFloorBoundariesType()                     const; ///< Read accessor for #m_boundariesType. For internal use.
...
public:
	...
	KyUInt8 m_boundariesType;                               ///< A mask that stores the types of boundaries this NavFloorBlob has with adjacent floors and cells.
};
...
KY_INLINE void SwapEndianness(Endianness::Target e, NavFloorBlob& self)
{
	...
	SwapEndianness(e, self.m_boundariesType);
