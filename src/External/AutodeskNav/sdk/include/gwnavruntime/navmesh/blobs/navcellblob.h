...
#include "gwnavruntime/navmesh/blobs/navfloorlinkinfo.h"
...
class NavCellBlob
{
	KY_ROOT_BLOB_CLASS(NavData, NavCellBlob, 0)
...
public:
	...
	BlobArray<NavFloorLinkInfo> m_floorLinkInfos; ///< The list of NavFloorLinkInfo maintained by the NavCellBlob. Do not modify.
...
inline void SwapEndianness(Endianness::Target e, NavCellBlob& self)
{
	...
	SwapEndianness(e, self.m_floorLinkInfos);
