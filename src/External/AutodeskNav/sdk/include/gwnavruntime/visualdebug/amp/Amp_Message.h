...
public:
    ...
    {
        KY_DEBUG_ASSERTN(msgType!=MessageTypeRegistry::InvalidMsgType, ("setting an invalid message type, check the registry"));
        MsgType = msgType; 
...
protected:
    ...
    Message(): MsgType(MessageTypeRegistry::InvalidMsgType), Version(InvalidVersion) {}
