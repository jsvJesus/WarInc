...
public:
	KyResult SplitTriangleAccordingToGeneratorSystem(const Vec3f& A, const Vec3f& B, const Vec3f& C, const  GeneratorSystem& generatorSystem, KyArray<Vec3f>& childrenLegitTriangles) const;

private: // internal usage
	KyResult StepSubDivide(const Vec3f& A, const Vec3f& B, const Vec3f& C, bool isCCW, KyArray<Vec3f>& children) const;
