...
#ifndef Navigation_GeneratorFileSystem_H
#define Navigation_GeneratorFileSystem_H
...
public:
	...
	{
		return ConcatToPath(m_absoluteOutputBaseDirectory, relativeFileName);
	}
	...
	KyResult RemoveAllFilesInDirectory(const char* dirName);
	...
	// has subdirectories... 
	KyResult RemoveDirectoryAndFilesInIt(const char* dirName);
...
public:
	...
	String m_absoluteOutputBaseDirectory; // concatenation of absoluteOutputBaseDir passed to Setup and m_relativeOutputDirectory
};
