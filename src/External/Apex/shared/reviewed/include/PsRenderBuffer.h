...
namespace shdfnd2
{
	...
	*/
	class RenderBuffer : public PxRenderBuffer, public UserAllocated
	{

		template <typename T>
		void append(Array<T>& dst, const T* src, PxU32 count)
		{
	...
	public:
		...
		Array<PxDebugPoint>		mPoints;
		Array<PxDebugLine>		mLines;
		Array<PxDebugTriangle>	mTriangles;
		Array<PxDebugText>		mTexts;
		Array<char>				mCharBuf;
	};
