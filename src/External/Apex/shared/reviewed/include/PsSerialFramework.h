...
#ifndef PS_SERIAL_FRAMEWORK_H
#define PS_SERIAL_FRAMEWORK_H
...
namespace shdfnd2
{
	...
	typedef HashMap<PxSerializable*, PxSerializable*> HashMapResolver;
	class RefResolver : public PxRefResolver, public UserAllocated
	{
		public:
	...
	typedef HashMap<void*, PxSerializable*> UserHashMapResolver;
	class UserReferences : public PxUserReferences, public UserAllocated
	{
		public:
	...
	// Extra data delimiter
	class ExtraDataMarker : public PxSerializable
	{
		public:
										ExtraDataMarker(PxRefResolver& v)	: PxSerializable(v)	{}
										DECLARE_SERIAL_CLASS(ExtraDataMarker, PxSerializable)

										ExtraDataMarker()		{ setType(NXTYPE_EXTRA_DATA);	}
		virtual							~ExtraDataMarker()	{}
	};

	typedef PxSerializable*	(*CreateClass)(char*& address, PxRefResolver& v);
