...
static physx::PxU32 getVariableTypeSize(RendererMaterial::VariableType type)
{
	physx::PxU32 size = 0;
	switch(type)
	{
...
RendererMaterial::Variable::Variable(const char *name, VariableType type, physx::PxU32 offset)
{
...
physx::PxU32 RendererMaterial::Variable::getDataOffset(void) const
{
	return m_offset;
}

physx::PxU32 RendererMaterial::Variable::getDataSize(void) const
{
