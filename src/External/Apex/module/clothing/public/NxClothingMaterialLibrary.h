#ifndef NX_CLOTHING_MATERIAL_LIBRARY_H
#define NX_CLOTHING_MATERIAL_LIBRARY_H
/*
...
#define NX_CLOTHING_MATERIAL_AUTHORING_TYPE_NAME "NxClothingMaterialLibrary"

class NxClothingMaterial;

/**
\brief Container for clothing materials

\deprecated This class is going to be removed from 1.1
*/
class NxClothingMaterialLibrary : public NxApexAsset
{
public:
	/**
	\brief release the material library

	\note, this is only successful if all references from NxClothingActors to any of the materials are removed
	\see NxClothingMaterialLibrary::getReferenceCount()
	*/
	...
	*/
	...
	\note index must be smaller than NxClothingMaterialLibrary::getNumMaterials()
	*/
...
protected:
	~NxClothingMaterialLibrary() {} // illegal
};
