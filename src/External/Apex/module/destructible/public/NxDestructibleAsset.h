...
*/
class NxDestructibleAssetAuthoring : public NxApexAssetAuthoring, public NxApexInterface
{
public:
...
*/
class NxDestructibleAsset : public NxApexAsset, public NxApexInterface
{
public:
	/** Instancing */
