...
*/
class NxIofxAsset : public NxApexAsset, public NxApexContext, public NxApexInterface
{
public:
...
class NxIofxAssetAuthoring : public NxApexAssetAuthoring, public NxApexInterface
{
};
