#include "NxApex.h"
#ifndef NX_USER_RENDER_INSTANCEBUFFER_H
#define NX_USER_RENDER_INSTANCEBUFFER_H
/*
...
*/
typedef NxApexRenderBufferData<NxRenderInstanceSemantic, NxRenderInstanceSemantic::Enum> NxApexRenderInstanceBufferData;
...
private:
	...
	virtual void writeBuffer(NxRenderInstanceSemantic::Enum semantic, const void* srcData, physx::PxU32 srcStride, physx::PxU32 firstDestElement, physx::PxU32 numElements) = 0;
#endif
};
