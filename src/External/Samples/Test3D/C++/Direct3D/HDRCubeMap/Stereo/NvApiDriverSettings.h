...
#define OGL_TEARING_FREE_SWAP_PRESENT_STRING       L"Tearing-free present for OGL apps"
...
enum ESetting {
    ...
    OGL_TEARING_FREE_SWAP_PRESENT_ID              = 0x20EE02B2,
    ...
    TOTAL_DWORD_SETTING_NUM = 55,
    TOTAL_WSTRING_SETTING_NUM = 2,
    TOTAL_SETTING_NUM = 57,
...
enum EValues_OGL_TEARING_FREE_SWAP_PRESENT {
    OGL_TEARING_FREE_SWAP_PRESENT_DISABLE                = 0x00000000,
    OGL_TEARING_FREE_SWAP_PRESENT_PREFERENCE_MASK        = 0x00000003,
    OGL_TEARING_FREE_SWAP_PRESENT_FIFO                   = 0x00000001,
    OGL_TEARING_FREE_SWAP_PRESENT_MOST_VISIBLE_PIXELS    = 0x00000002,
    OGL_TEARING_FREE_SWAP_PRESENT_LARGEST_WINDOW         = 0x00000003,
    OGL_TEARING_FREE_SWAP_PRESENT_ALLOWANCE_MASK         = 0x00000004,
    OGL_TEARING_FREE_SWAP_PRESENT_MODE_SPANNING          = 0x00000000,
    OGL_TEARING_FREE_SWAP_PRESENT_MODE_NO_SPANNING       = 0x00000004,
    OGL_TEARING_FREE_SWAP_PRESENT_NUM_VALUES = 8,
    OGL_TEARING_FREE_SWAP_PRESENT_DEFAULT = OGL_TEARING_FREE_SWAP_PRESENT_DISABLE
};
...
enum EValues_AA_BEHAVIOR_FLAGS {
    ...
    AA_BEHAVIOR_FLAGS_MASK                               = 0xff0f000f,
    AA_BEHAVIOR_FLAGS_NUM_VALUES = 17,
};
...
enum EValues_WKS_API_STEREO_MODE {
    ...
    WKS_API_STEREO_MODE_NUM_VALUES = 22,
