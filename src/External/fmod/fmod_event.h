...
#define FMOD_EVENT_VERSION 0x00043807
...
typedef enum
{
    ...
    FMOD_EVENTPROPERTY_PITCHRANDOMIZATION_MODE,         /* Type : int       - 1 (default) = randomize pitch when the event is started and every time setPitch is called, 2 = only randomize pitch when the event is started */
