...
R3D_DX11_FORMAT r3dDX11_ConvertLegacyD3DFormat(int d3dFormat)
{
	...
	case D3DFMT_A8B8G8R8:
		return (R3D_DX11_FORMAT)DXGI_FORMAT_R8G8B8A8_UNORM;

	case D3DFMT_A2R10G10B10:
		return (R3D_DX11_FORMAT)DXGI_FORMAT_R10G10B10A2_UNORM;
	...
	case D3DFMT_G32R32F:
		return (R3D_DX11_FORMAT)DXGI_FORMAT_R32G32_FLOAT;

	case D3DFMT_A32B32G32R32F:
		return (R3D_DX11_FORMAT)DXGI_FORMAT_R32G32B32A32_FLOAT;

	case D3DFMT_R16F:
		return (R3D_DX11_FORMAT)DXGI_FORMAT_R16_FLOAT;

	case D3DFMT_L16:
		return (R3D_DX11_FORMAT)DXGI_FORMAT_R16_UNORM;
