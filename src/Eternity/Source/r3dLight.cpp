...
{
	if( ShadowDepth && ( FrozenShadowDepthSize != ShadowDepth->GetWidth() || !bFrozenShadowDepth ) )
	{
		r3dRenderer->DeleteTexture( ShadowDepth ) ;
		ShadowDepth = 0 ;
	}

	if( !ShadowDepth && bFrozenShadowDepth )
	{
