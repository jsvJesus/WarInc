...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [CheatLog] ON
GO
SET IDENTITY_INSERT [CheatLog] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [ClanApplications] ON
GO
SET IDENTITY_INSERT [ClanApplications] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [ClanData] ON
GO
SET IDENTITY_INSERT [ClanData] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [ClanEvents] ON
GO
SET IDENTITY_INSERT [ClanEvents] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [ClanInvites] ON
GO
SET IDENTITY_INSERT [ClanInvites] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [DBG_BanLog] ON
GO
SET IDENTITY_INSERT [DBG_BanLog] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [DBG_GPTransactions] ON
GO
SET IDENTITY_INSERT [DBG_GPTransactions] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [DBG_LootRewards] ON
GO
SET IDENTITY_INSERT [DBG_LootRewards] OFF
GO
COMMIT TRANSACTION
GO
...
-- ----------------------------
CREATE TABLE [DBG_PasswordResets] (
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [DBG_PasswordResets] ON
GO
SET IDENTITY_INSERT [DBG_PasswordResets] OFF
GO
COMMIT TRANSACTION
GO
...
GO
DBCC CHECKIDENT(N'[DBG_SrvLogInfo]', RESEED, 8)
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [DBG_SrvLogInfo] ON
GO
SET IDENTITY_INSERT [DBG_SrvLogInfo] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [DBG_WOAdminChanges] ON
GO
SET IDENTITY_INSERT [DBG_WOAdminChanges] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301118', N'Loot_Drop_Premium_01', N'7', N'WEAP - Melee', N'spawns of War Z Weapons', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
...
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301125', N'Item_LootBox', N'7', N'GEAR - Medical', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301126', N'Item_LootBox', N'7', N'FOOD - Generic', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301127', N'Item_LootBox', N'7', N'FOOD - Advanced Meal', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301128', N'Item_LootBox', N'7', N'FOOD - GC Grade', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301129', N'Item_LootBox', N'7', N'WEAP - Ammo Law', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301130', N'Item_LootBox', N'7', N'SPAWN - Camping', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301132', N'Item_LootBox', N'7', N'SPAWN - Rural - Residential', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301133', N'Item_LootBox', N'7', N'SPAWN - Rural - Commercial', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301134', N'Item_LootBox', N'7', N'SPAWN - Rural - Law', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301135', N'Item_LootBox', N'7', N'SPAWN - Military 1', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301136', N'Item_LootBox', N'7', N'ZOMBIE- Money', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301137', N'Item_LootBox', N'7', N'GEAR - Survival', N'', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301151', N'Account_ClanCreate', N'1', N'Account_ClanCreate', N'clan create item', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301152', N'Account_ClanUpg1', N'1', N'Account_ClanUpg1', N'buy price is in permanent GC ($) \r\nNOTE- number of added clan members is in **permanent GD** price', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301153', N'Account_ClanUpg2', N'1', N'Account_ClanUpg2', N'buy price is in permanent GC ($) \r\nNOTE- number of added clan members is in **permanent GD** price', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301154', N'Account_ClanUpg3', N'1', N'Account_ClanUpg3', N'buy price is in permanent GC ($) \r\nNOTE- number of added clan members is in **permanent GD** price', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301155', N'Account_ClanUpg4', N'1', N'Account_ClanUpg4', N'buy price is in permanent GC ($) \r\nNOTE- number of added clan members is in **permanent GD** price', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301156', N'Account_ClanUpg5', N'1', N'Account_ClanUpg5', N'buy price is in permanent GC ($) \r\nNOTE- number of added clan members is in **permanent GD** price', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
INSERT INTO [Items_Generic] ([ItemID], [FNAME], [Category], [Name], [Description], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [Weight]) VALUES (N'301157', N'Account_ClanUpg6', N'1', N'Account_ClanUpg6', N'buy price is in permanent GC ($) \r\nNOTE- number of added clan members is in **permanent GD** price', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0');
...
GO
DBCC CHECKIDENT(N'[Items_LootData]', RESEED, 142)
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [Items_LootData] ON
GO
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'1', N'301118', N'20', N'101267', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'2', N'301118', N'40', N'101309', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'3', N'301118', N'50', N'101308', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'4', N'301118', N'300', N'101307', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'5', N'301118', N'500', N'-1', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'6', N'301118', N'900', N'101278', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'7', N'301119', N'1', N'101032', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'8', N'301119', N'1', N'101098', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'9', N'301119', N'2', N'101111', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'10', N'301119', N'5', N'101040', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'11', N'301119', N'10', N'101158', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'12', N'301119', N'10', N'101115', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'13', N'301119', N'100', N'-1', N'0', N'0');
...
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'33', N'301122', N'1', N'400043', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'34', N'301122', N'4', N'400070', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'35', N'301122', N'10', N'400017', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'36', N'301122', N'30', N'400048', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'37', N'301122', N'60', N'400073', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'38', N'301122', N'70', N'400101', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'39', N'301122', N'70', N'400016', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'40', N'301122', N'100', N'400136', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'41', N'301122', N'100', N'400137', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'42', N'301122', N'200', N'400071', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'43', N'301122', N'400', N'-1', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'44', N'301123', N'100', N'400000', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'45', N'301123', N'2000', N'-1', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'46', N'301124', N'10', N'20056', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'47', N'301124', N'10', N'20015', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'48', N'301124', N'60', N'20043', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'49', N'301124', N'60', N'20047', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'50', N'301124', N'60', N'20048', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'51', N'301124', N'100', N'20096', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'52', N'301124', N'100', N'20097', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'53', N'301124', N'100', N'20098', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'54', N'301124', N'100', N'20177', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'55', N'301124', N'100', N'20178', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'56', N'301124', N'100', N'20023', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'57', N'301124', N'100', N'20032', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'58', N'301124', N'100', N'20035', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'59', N'301124', N'100', N'20041', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'60', N'301124', N'100', N'20042', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'61', N'301124', N'1000', N'-1', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'62', N'301125', N'5', N'101304', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'63', N'301125', N'7', N'101302', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'64', N'301125', N'10', N'101262', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'65', N'301125', N'30', N'101256', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'66', N'301125', N'60', N'101300', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'67', N'301125', N'80', N'101261', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'68', N'301125', N'200', N'-1', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'69', N'301126', N'22', N'101293', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'70', N'301126', N'24', N'101292', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'71', N'301126', N'26', N'101291', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'72', N'301126', N'30', N'101290', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'73', N'301126', N'50', N'101297', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'74', N'301126', N'50', N'101298', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'75', N'301126', N'50', N'101286', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'76', N'301126', N'50', N'101294', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'77', N'301126', N'100', N'101283', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'78', N'301126', N'100', N'101285', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'79', N'301126', N'100', N'101288', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'80', N'301126', N'100', N'101289', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'81', N'301126', N'110', N'101296', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'82', N'301126', N'400', N'101299', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'83', N'301126', N'600', N'-1', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'84', N'301127', N'10', N'101295', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'85', N'301127', N'20', N'101286', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'86', N'301127', N'50', N'101298', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'87', N'301127', N'60', N'101297', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'88', N'301127', N'100', N'101290', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'89', N'301127', N'100', N'101291', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'90', N'301127', N'100', N'101292', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'91', N'301127', N'100', N'101293', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'92', N'301127', N'100', N'101299', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'93', N'301127', N'150', N'101285', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'94', N'301127', N'2000', N'-1', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'95', N'301128', N'100', N'101284', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'96', N'301128', N'100', N'101295', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'97', N'301128', N'2000', N'-1', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'98', N'301129', N'1', N'400070', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'99', N'301129', N'10', N'400050', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'100', N'301129', N'10', N'400079', N'0', N'0');
GO
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'101', N'301129', N'10', N'400017', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'102', N'301129', N'25', N'400015', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'103', N'301129', N'30', N'400016', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'104', N'301129', N'100', N'400071', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'105', N'301129', N'200', N'-1', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'106', N'301130', N'10', N'301118', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'107', N'301130', N'10', N'301137', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'108', N'301130', N'30', N'301125', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'109', N'301130', N'100', N'301126', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'110', N'301132', N'5', N'301119', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'111', N'301132', N'5', N'301122', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'112', N'301132', N'10', N'301137', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'113', N'301132', N'20', N'301125', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'114', N'301132', N'100', N'301126', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'115', N'301133', N'10', N'301119', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'116', N'301133', N'10', N'301122', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'117', N'301133', N'10', N'301124', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'118', N'301133', N'30', N'301126', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'119', N'301133', N'30', N'301137', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'120', N'301133', N'100', N'301125', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'121', N'301134', N'20', N'301120', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'122', N'301134', N'20', N'301129', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'123', N'301134', N'60', N'301128', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'124', N'301134', N'100', N'301124', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'125', N'301134', N'100', N'301125', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'126', N'301135', N'10', N'301123', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'127', N'301135', N'20', N'301121', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'128', N'301135', N'100', N'301124', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'129', N'301135', N'100', N'301127', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'130', N'301135', N'100', N'301125', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'131', N'301136', N'20', N'0', N'50', N'100');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'132', N'301136', N'40', N'-1', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'133', N'301137', N'1', N'101316', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'134', N'301137', N'1', N'101317', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'135', N'301137', N'20', N'20179', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'136', N'301137', N'40', N'20175', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'137', N'301137', N'70', N'101307', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'138', N'301137', N'100', N'101315', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'139', N'301137', N'100', N'101311', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'140', N'301137', N'100', N'101312', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'141', N'301137', N'100', N'101306', N'0', N'0');
INSERT INTO [Items_LootData] ([RecordID], [LootID], [Chance], [ItemID], [GDMin], [GDMax]) VALUES (N'142', N'301137', N'100', N'-1', N'0', N'0');
GO
SET IDENTITY_INSERT [Items_LootData] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101002', N'ASR_M16', N'20', N'M16', N'The M16 rifle is a gas operated standard infantry assault rifle, chambered for 5.56x45mm NATO round.', N'0 0 0', N'muzzle_asr', N'assault', N'5.56', N'Sounds/NewWeapons/Assault/ColtM16', N'Sounds/Weapons/New Reloads/M16-Reload', N'27', N'0', N'1', N'500', N'300', N'0', N'0', N'0', N'0', N'1', N'2', N'0', N'625', N'9', N'7', N'0', N'asr_grenade', N'101', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'2001', N'5001', N'3001', N'1001', N'4001', N'0', N'0', N'0', N'0', N'0', N'400127', N'0', N'0', N'400016', N'0', N'0', N'0', N'0', N'ASR_M16', N'4000');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101035', N'ASR_AKS74U', N'26', N'AKS-74U', N'The AKS-74U is a shortened gas operated carbine version of the AKS-74 assault rifle. It fires a 5.45 x 39 mm round and is very effective at medium ranges.', N'0 0 0', N'muzzle_asr', N'assault', N'5.45', N'Sounds/NewWeapons/Assault/AKS-74U', N'Sounds/Weapons/ASR/ASR_Generic_Reload', N'27', N'0', N'1', N'500', N'55', N'0', N'0', N'0', N'0', N'1', N'3', N'0', N'650', N'12', N'5', N'0', N'asr_grenade', N'101', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'32', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'2001', N'5001', N'3001', N'1001', N'4200', N'0', N'0', N'0', N'0', N'0', N'400129', N'0', N'0', N'400001', N'0', N'0', N'0', N'0', N'ASR_AKS74U', N'2700');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101040', N'ASR_SIG516', N'20', N'M4 Semi', N'The civilian M4 semi auto rifle, chambered for 5.56x45mm NATO round.', N'0 0 0', N'muzzle_asr', N'assault', N'5.45', N'Sounds/NewWeapons/Assault/HK_416', N'Sounds/Weapons/New Reloads/M16-Reload', N'35', N'0', N'1', N'500', N'300', N'0', N'0', N'0', N'0', N'1', N'2', N'0', N'650', N'9', N'9', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'46', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'2001', N'5001', N'3001', N'1001', N'4001', N'0', N'0', N'0', N'0', N'0', N'400058', N'0', N'0', N'400016', N'0', N'0', N'0', N'0', N'ASR_SIG516', N'3000');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101084', N'SNP_Vintorez', N'21', N'VSS VINTOREZ', N'The VSS Vintorez sniper rifle was designed to fire a 9 x 39 mm round using a gas operated, rotating bolt firing system. It is designed to be effective at medium distances.', N'0 0 0', N'muzzle_asr', N'assault', N'Sniper5.45', N'Sounds/NewWeapons/Sniper/VSS_Vintorez', N'Sounds/Weapons/ASR/ASR_Generic_Reload', N'125', N'0', N'2', N'700', N'200', N'0', N'0', N'0', N'0', N'1', N'3', N'1', N'200', N'2', N'5', N'0', N'asr_grenade', N'101', N'30', N'pso1', N'60', N'0', N'0', N'0', N'0', N'0', N'45', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'6001', N'3001', N'0', N'4002', N'0', N'0', N'0', N'0', N'0', N'400027', N'0', N'0', N'400031', N'0', N'0', N'0', N'0', N'SNP_Vintorez', N'2500');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101095', N'MG_M249_SAW', N'23', N'FN M249 ', N'The FN M249 machine gun fires a 5.56 mm round from a belt fed system. It is highly effective against targets at close and medium ranges.', N'0 0 0', N'muzzle_asr', N'assault', N'5.45', N'Sounds/NewWeapons/LightMachineGun/FN_M249', N'Sounds/Weapons/New Reloads/MG_M240_SAW_Reload', N'31', N'0', N'1', N'600', N'300', N'0', N'0', N'0', N'0', N'1', N'6', N'2', N'600', N'14', N'5', N'0', N'asr_grenade', N'001', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'25', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'5001', N'3001', N'1001', N'0', N'0', N'0', N'0', N'0', N'0', N'400035', N'0', N'0', N'400143', N'0', N'0', N'0', N'0', N'MG_M249', N'10000');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101173', N'ASR_tar21', N'20', N'IMI TAR-21', N'The TAR-21 is an unique gas operated, rotating bolt, bullpup design assault rifle that fires a 5.56 x 45 mm round. It is extremely effective at close and medium range.', N'0 0 0', N'muzzle_asr', N'assault', N'5.45', N'Sounds/NewWeapons/Assault/HK_G11', N'Sounds/Weapons/New Reloads/G36-Reload', N'33', N'0', N'1', N'500', N'300', N'0', N'0', N'0', N'0', N'1', N'2', N'0', N'700', N'6', N'7', N'0', N'asr_grenade', N'101', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'39', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'2001', N'5001', N'0', N'0', N'4001', N'0', N'0', N'0', N'0', N'0', N'400059', N'0', N'0', N'400016', N'0', N'0', N'0', N'0', N'ASR_tar21', N'3300');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101180', N'HG_Desert_Eagle', N'25', N'Desert Eagle', N'The Desert Eagle handgun was designed to fire a .50 caliber round and deals a substancial amount of damage to targets at close ranges.', N'0 0 0', N'muzzle_hg', N'pistol', N'5.45', N'Sounds/NewWeapons/Handgun/DesertEagle', N'Sounds/Weapons/HG/HG_Generic_Reload', N'50', N'0', N'1', N'500', N'40', N'0', N'0', N'0', N'0', N'1', N'2', N'0', N'800', N'12', N'22', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'45', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'8001', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'400086', N'0', N'0', N'0', N'0', N'HG_Desert_Eagle', N'1750');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101183', N'SHG_Keltech', N'22', N'KT DECIDER', N'The KT Decider is a bull-pup shotgun design that has two magazine feed tubes, each side capable of holding 7 shells, for a total capacity of 14+1.', N'0 0 0', N'muzzle_sh1', N'assault', N'buckshot', N'Sounds/NewWeapons/Shotgun/SHG_Keltech', N'Sounds/Weapons/New Reloads/SHG_Keltech_reload', N'25', N'0', N'1', N'300', N'15', N'0', N'0', N'0', N'0', N'1', N'8', N'1', N'50', N'20', N'15', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'35', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'5001', N'3001', N'1001', N'0', N'0', N'0', N'0', N'0', N'0', N'400036', N'0', N'0', N'400136', N'0', N'0', N'0', N'0', N'SHG_Keltech', N'4000');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101224', N'HG_Jericho', N'25', N'STI Eagle Elite .45 ACP', N'The STI Eagle Elite handgun is an upgraded version of the STI Eagle and is designed to fire a .45 ACP round effectively at close ranges.', N'0 0 0', N'muzzle_asr', N'assault', N'5.45', N'Sounds/NewWeapons/Handgun/DesertEagle', N'Sounds/Weapons/HG/HG_Generic_Reload', N'36', N'0', N'1', N'500', N'45', N'0', N'0', N'0', N'0', N'1', N'2', N'0', N'800', N'9', N'9', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'HG_Jericho', N'1500');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101246', N'SMG_PS90', N'26', N'FN P90 S', N'The FN P90S submachine gun is a highly effective weapon that carries a unique 50 round magazine. It fires a standard 5.56 mm round.', N'0 0 0', N'muzzle_asr', N'assault', N'5.45', N'Sounds/NewWeapons/SMG/FN_P90', N'Sounds/Weapons/New Reloads/G36-Reload', N'26', N'0', N'1', N'500', N'40', N'0', N'0', N'0', N'0', N'1', N'2', N'2', N'900', N'11', N'8', N'0', N'asr_grenade', N'101', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'58', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'2001', N'5001', N'3001', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'400054', N'0', N'0', N'400046', N'0', N'0', N'0', N'0', N'smg_p90', N'3000');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101256', N'Consumables_Med_01', N'28', N'Antibiotics', N'Over the counter antibiotics that aid in curing colds and other minor ailments.', N'0 0 0', N'muzzle_asr', N'mine', N'5.45', N'', N'', N'25', N'1', N'10', N'300', N'50', N'0', N'0', N'0', N'1', N'1', N'4', N'2', N'10', N'20', N'20', N'0', N'asr_grenade', N'101', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'4500', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'100');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101261', N'Item_bandage_01', N'28', N'Bandages ', N'Common bandages which heal minor wounds and stops excessive bleeding.', N'0 0 0', N'muzzle_asr', N'assault', N'5.45', N'', N'', N'10', N'1', N'10', N'300', N'50', N'0', N'0', N'0', N'1', N'1', N'4', N'2', N'20', N'20', N'20', N'0', N'asr_grenade', N'101', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'4000', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'200');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101262', N'Item_bandage_02', N'28', N'Bandages DX', N'Medical bandages which heal moderate wounds and stops excessive bleeding.', N'0 0 0', N'muzzle_asr', N'assault', N'5.45', N'', N'', N'45', N'1', N'10', N'300', N'50', N'0', N'0', N'0', N'1', N'5', N'4', N'2', N'30', N'20', N'20', N'0', N'asr_grenade', N'101', N'30', N'default', N'0', N'0', N'0', N'0', N'250', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'100');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101300', N'Consumables_PainKiller_01', N'28', N'Pain killers', N'Over the counter pain killers that counter-act the effects of pain on the body.', N'0 0 0', N'muzzle_asr', N'assault', N'5.45', N'', N'', N'15', N'1', N'10', N'300', N'50', N'0', N'0', N'0', N'1', N'1', N'4', N'2', N'10', N'20', N'20', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'6000', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'100');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101310', N'EXP_M26', N'27', N'Frag Grenade', N'The fragmentation grenade is used to spray shrapnel upon exploding. Pull the pin and dont forget to throw it far.. Fire in the hole!', N'0 0 0', N'', N'grenade', N'grenade', N'', N'', N'50', N'0', N'10', N'20', N'50', N'10', N'4', N'0', N'1', N'1', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'EXP_M26', N'180');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101320', N'HG_FlareGun', N'25', N'Flare Gun', N'', N'0 0 0', N'muzzle_hg', N'pistol', N'Flare', N'Sounds/NewWeapons/SMG/HK_MP5SD', N'Sounds/Weapons/HG/HG_Generic_Reload', N'5', N'0', N'10', N'50', N'50', N'0', N'180', N'0', N'0', N'1', N'2', N'2', N'60', N'15', N'5', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'400152', N'0', N'0', N'0', N'0', N'HG_FlareGun', N'1000');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101322', N'SNP_CrossBow', N'20', N'Compound Crossbow', N'String drawn compound hunting crossbow for silent kills. Uses bow arrows for ammo', N'0 0 0', N'', N'assault', N'Sniper5.45', N'Sounds/NewWeapons/Special/Crossbow', N'Sounds/Weapons/New Reloads/Crossbow-Reload', N'20', N'1', N'1', N'600', N'50', N'0', N'0', N'0', N'0', N'1', N'2', N'2', N'60', N'2', N'2', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'5001', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'400140', N'0', N'0', N'0', N'0', N'SNP_CrossBow', N'3500');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101330', N'HG_Ruger', N'25', N'Ruger', N'Reliable and relatively common, the lower powered Kruger .22 is a household staple, allowing for low cost practice with firm control', N'0 0 0', N'muzzle_hg', N'pistol', N'5.45', N'Sounds/NewWeapons/Handgun/Ruger22', N'Sounds/Weapons/HG/HG_Generic_Reload', N'20', N'0', N'1', N'500', N'35', N'0', N'0', N'0', N'0', N'1', N'2', N'2', N'800', N'9', N'3', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'8001', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'400144', N'0', N'0', N'0', N'0', N'HG_Ruger', N'600');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101331', N'HG_Colt_Anaconda', N'25', N'Colt Anaconda', N'Introduced in 1990, the Colt Anaconda is a large double action .44 caliber revolver featuring a six round cylinder, designed and produced by the Colt''s Manufacturing Company', N'0 0 0', N'muzzle_hg', N'pistol', N'5.45', N'Sounds/NewWeapons/Handgun/DesertEagle', N'Sounds/Weapons/HG/HG_Generic_Reload', N'45', N'0', N'1', N'500', N'40', N'0', N'0', N'0', N'0', N'1', N'2', N'0', N'800', N'10', N'20', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'400145', N'0', N'0', N'0', N'0', N'HG_Colt_Anaconda', N'1750');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101342', N'HG_colt_1911', N'25', N'1911', N'Standard US service pistol known for its minimal recoil and light weight', N'0 0 0', N'muzzle_hg', N'pistol', N'Sniper5.45', N'Sounds/NewWeapons/Handgun/9mmGeneric', N'Sounds/Weapons/HG/HG_Generic_Reload', N'35', N'0', N'1', N'500', N'40', N'0', N'0', N'0', N'0', N'1', N'2', N'0', N'800', N'4', N'2', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'8001', N'0', N'3002', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'400154', N'0', N'0', N'0', N'0', N'HG_colt_1911', N'650');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101344', N'MEL_Canoe_paddle', N'29', N'Canoe Paddle', N'Wooden canoe paddle', N'0 0 0', N'', N'melee', N'melee', N'Sounds/NewWeapons/Melee/Melee_Whoosh', N'', N'30', N'1', N'10', N'300', N'1', N'0', N'0', N'0', N'0', N'1', N'0', N'0', N'90', N'0', N'0', N'0', N'asr_grenade', N'001', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'MEL_Canoe_paddle', N'1000');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101345', N'MEL_Cricket_bat', N'29', N'Cricket bat', N'Score some runs and crush some skulls!', N'0 0 0', N'', N'melee', N'melee', N'Sounds/NewWeapons/Melee/Melee_Whoosh', N'', N'35', N'1', N'10', N'300', N'1', N'0', N'0', N'0', N'0', N'1', N'0', N'0', N'90', N'0', N'0', N'0', N'asr_grenade', N'001', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'MEL_Cricket_bat', N'800');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101347', N'MEL_Chainsaw', N'29', N'Chainsaw', N'Tear through undead and living alike with this fearsome household tool', N'0 0 0', N'', N'melee', N'melee', N'', N'', N'50', N'1', N'10', N'300', N'1', N'0', N'0', N'0', N'0', N'1', N'0', N'0', N'120', N'0', N'0', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'MEL_Chainsaw', N'1200');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101358', N'Block_PowerGen_Indust_01', N'28', N'Industrial power generator', N'Industrial strength power generator', N'0 0 0', N'', N'assault', N'melee', N'', N'', N'300', N'1', N'10', N'60', N'1', N'0', N'0', N'0', N'1', N'5', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'500');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101360', N'Block_SolarWater_01', N'28', N'Solar Water Purifier', N'Small solar powered water purifier', N'0 0 0', N'', N'assault', N'melee', N'', N'', N'200', N'1', N'10', N'60', N'1', N'0', N'0', N'0', N'1', N'5', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'500');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101361', N'Block_Light_01', N'28', N'Placeable light', N'Moveable, placeable light source', N'0 0 0', N'', N'assault', N'melee', N'', N'', N'200', N'1', N'10', N'60', N'1', N'0', N'0', N'0', N'1', N'5', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'200');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101362', N'Block_Farm_ChipBag_01', N'28', N'Bag of Chips farm block', N'', N'0 0 0', N'', N'assault', N'melee', N'', N'', N'200', N'1', N'10', N'60', N'1', N'0', N'0', N'0', N'1', N'5', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'300');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101371', N'Block_Door_Wood_2M_01_Crate', N'28', N'Wood Door Crate 2M', N'', N'0 0 0', N'', N'assault', N'melee', N'', N'', N'300', N'1', N'10', N'60', N'1', N'0', N'0', N'0', N'1', N'5', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'350');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101372', N'Block_Farm_01_Crate', N'28', N'Farm Block Crate', N'', N'0 0 0', N'', N'assault', N'melee', N'', N'', N'300', N'1', N'10', N'60', N'1', N'0', N'0', N'0', N'1', N'5', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'300');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101373', N'Block_Light_01_Crate', N'28', N'Light block crate', N'', N'0 0 0', N'', N'assault', N'melee', N'', N'', N'300', N'1', N'10', N'60', N'1', N'0', N'0', N'0', N'1', N'5', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'300');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101377', N'Block_Wall_Brick_Short_01_Crate', N'28', N'Short Brick Wall crate', N'', N'0 0 0', N'', N'assault', N'melee', N'', N'', N'300', N'1', N'10', N'60', N'1', N'0', N'0', N'0', N'1', N'5', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'300');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101378', N'Block_Wall_Brick_Tall_01_Crate', N'28', N'Tall Brick wall crate', N'', N'0 0 0', N'', N'assault', N'melee', N'', N'', N'300', N'1', N'10', N'60', N'1', N'0', N'0', N'0', N'1', N'5', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'300');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101379', N'Block_Wall_Metal_2M_01_Crate', N'28', N'Tall 2M Metal Wall Block crate', N'', N'0 0 0', N'', N'assault', N'melee', N'', N'', N'300', N'1', N'10', N'60', N'1', N'0', N'0', N'0', N'1', N'5', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'300');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101380', N'Block_Wall_Wood_2M_01_Crate', N'28', N'Wood Wall block crate, 2M', N'', N'0 0 0', N'', N'assault', N'melee', N'', N'', N'300', N'1', N'10', N'60', N'1', N'0', N'0', N'0', N'1', N'5', N'1', N'0', N'60', N'1', N'1', N'0', N'asr_grenade', N'100', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'300');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101383', N'Mel_FireAxe', N'29', N'Fire Axe', N'Standard issue axe used by firefighters to enter buildings and remove dangerous debris', N'0 0 0', N'', N'melee', N'melee_sharp', N'Sounds/NewWeapons/Melee/Melee_Whoosh', N'', N'40', N'1', N'10', N'300', N'1', N'0', N'0', N'0', N'0', N'1', N'0', N'0', N'90', N'0', N'0', N'0', N'asr_grenade', N'001', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'Mel_FireAxe', N'1200');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101384', N'Mel_FryingPan', N'29', N'Frying Pan', N'Whether frying an egg or flattening a face, the common household frying pan has many uses', N'0 0 0', N'', N'melee', N'melee', N'Sounds/NewWeapons/Melee/Melee_Whoosh', N'', N'20', N'1', N'10', N'300', N'1', N'0', N'0', N'0', N'0', N'1', N'0', N'0', N'90', N'0', N'0', N'0', N'asr_grenade', N'001', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'Mel_FryingPan', N'1100');
...
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101386', N'Mel_Golf_Club', N'29', N'Golf Club', N'Best used for long drives. FORE!', N'0 0 0', N'', N'melee', N'melee', N'Sounds/NewWeapons/Melee/Melee_Whoosh', N'', N'30', N'1', N'10', N'300', N'1', N'0', N'0', N'0', N'0', N'1', N'0', N'0', N'90', N'0', N'0', N'0', N'asr_grenade', N'001', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'Mel_Golf_Club', N'800');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101388', N'Mel_Pitchfork', N'29', N'Pitchfork', N'Designed to move hay economically, its intimidating design suits it well to sticking some undead', N'0 0 0', N'', N'melee', N'melee_sharp', N'Sounds/NewWeapons/Melee/Melee_Whoosh', N'', N'40', N'1', N'10', N'300', N'1', N'0', N'0', N'0', N'0', N'1', N'0', N'0', N'90', N'0', N'0', N'0', N'asr_grenade', N'001', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'Mel_Pitchfork', N'1400');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101389', N'Mel_PoliceBaton', N'29', N'Police Baton', N'Used by law enforcement as an aid in hand to hand combat, often to subdue unruly or resistant suspects', N'0 0 0', N'', N'melee', N'melee', N'Sounds/NewWeapons/Melee/Melee_Whoosh', N'', N'30', N'1', N'10', N'300', N'1', N'0', N'0', N'0', N'0', N'1', N'0', N'0', N'90', N'0', N'0', N'0', N'asr_grenade', N'001', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'700');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101390', N'Mel_Power_Drill', N'29', N'Power Drill', N'Battery powered and unconventional, the drill is quite effective at dispatching enemies in the grisliest way', N'0 0 0', N'', N'melee', N'melee_sharp', N'', N'', N'40', N'1', N'10', N'300', N'1', N'0', N'0', N'0', N'0', N'1', N'0', N'0', N'120', N'0', N'0', N'0', N'asr_grenade', N'001', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'900');
INSERT INTO [Items_Weapons] ([ItemID], [FNAME], [Category], [Name], [Description], [MuzzleOffset], [MuzzleParticle], [Animation], [BulletID], [Sound_Shot], [Sound_Reload], [Damage], [isImmediate], [Mass], [Speed], [DamageDecay], [Area], [Delay], [Timeout], [NumClips], [Clipsize], [ReloadTime], [ActiveReloadTick], [RateOfFire], [Spread], [Recoil], [NumGrenades], [GrenadeName], [Firemode], [DetectionRadius], [ScopeType], [ScopeZoom], [Price1], [Price7], [Price30], [PriceP], [IsNew], [LevelRequired], [GPrice1], [GPrice7], [GPrice30], [GPriceP], [ShotsFired], [ShotsHits], [KillsCQ], [KillsDM], [KillsSB], [IsUpgradeable], [IsFPS], [FPSSpec0], [FPSSpec1], [FPSSpec2], [FPSSpec3], [FPSSpec4], [FPSSpec5], [FPSSpec6], [FPSSpec7], [FPSSpec8], [FPSAttach0], [FPSAttach1], [FPSAttach2], [FPSAttach3], [FPSAttach4], [FPSAttach5], [FPSAttach6], [FPSAttach7], [FPSAttach8], [AnimPrefix], [Weight]) VALUES (N'101391', N'Mel_Wrench', N'29', N'Wrench', N'Loved by plumbers around the world, this hefty tool can easily collapse the skulls of your foes', N'0 0 0', N'', N'melee', N'melee', N'Sounds/NewWeapons/Melee/Melee_Whoosh', N'', N'20', N'1', N'10', N'300', N'1', N'0', N'0', N'0', N'0', N'1', N'0', N'0', N'90', N'0', N'0', N'0', N'asr_grenade', N'001', N'30', N'default', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'1', N'1', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'0', N'', N'1200');
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [Leaderboard1] ON
GO
SET IDENTITY_INSERT [Leaderboard1] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [Leaderboard30] ON
GO
SET IDENTITY_INSERT [Leaderboard30] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [Leaderboard7] ON
GO
SET IDENTITY_INSERT [Leaderboard7] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [SecurityLog] ON
GO
SET IDENTITY_INSERT [SecurityLog] OFF
GO
COMMIT TRANSACTION
GO
...
GO
DBCC CHECKIDENT(N'[ServerNotesData]', RESEED, 2)
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [ServerNotesData] ON
GO
SET IDENTITY_INSERT [ServerNotesData] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [UsersChars] ON
GO
SET IDENTITY_INSERT [UsersChars] OFF
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
SET IDENTITY_INSERT [UsersInventory] ON
GO
SET IDENTITY_INSERT [UsersInventory] OFF
GO
COMMIT TRANSACTION
GO
...
CREATE PROCEDURE [ADMIN_BanUser]
	@in_CustomerID int,
...
CREATE PROCEDURE [ADMIN_BanWeaponHackers]
AS  
BEGIN  
	SET NOCOUNT ON;  
	declare @hacks TABLE 
...
-- =============================================
CREATE PROCEDURE [DB_PurgeUnusedUserData]
AS
BEGIN
...
CREATE PROCEDURE [DBG_RegisterIISCall]
	@in_API	varchar(128),
	@in_BytesIn int,
	@in_BytesOut int
AS
...
-- Description:	
-- =============================================
CREATE PROCEDURE [FN_ADD_SECURITY_LOG] 
...
CREATE PROCEDURE [FN_AddItemToUser]
	@in_CustomerID int,
	@in_ItemID int,
	@in_ExpDays int
AS
...
CREATE PROCEDURE [FN_AlterUserGP]
	@in_CustomerID int,
	@in_GP int,
...
CREATE PROCEDURE [FN_BackpackValidateItem] 
	@in_CharID int,
	@in_ItemID int,
	@in_EquipIdx int
AS
...
CREATE PROCEDURE [FN_CreateMD5Password]
...
CREATE PROCEDURE [FN_LevelUpBonus] 
       @in_CustomerID int,
       @in_LevelUp int
AS
BEGIN
...
CREATE PROCEDURE [TEMP_AddGPToUser]
...
CREATE PROCEDURE [WZ_ACCOUNT_APPLYKEY]
	@in_CustomerID int,
...
CREATE PROCEDURE [WZ_ACCOUNT_ChangePassword]
	@in_CustomerID int, 
...
CREATE PROCEDURE [WZ_ACCOUNT_CREATE]
	@in_IP varchar(64),
	@in_Email varchar(128),
...
CREATE PROCEDURE [WZ_ACCOUNT_DELETE]
	@in_CustomerID int
AS
BEGIN
	SET NOCOUNT ON;
...
CREATE PROCEDURE [WZ_ACCOUNT_LOGIN]
	@in_IP varchar(100),
...
CREATE PROCEDURE [WZ_ACCOUNT_LOGIN_EXEC]
	@in_IP varchar(100),
	@CustomerID int
AS
BEGIN
...
CREATE PROCEDURE [WZ_Backpack_SRV_AddItem] 
	@in_CustomerID int,
	@in_CharID int,
	@in_Slot int,
	@in_ItemID int,
...
CREATE PROCEDURE [WZ_Backpack_SRV_AlterItem] 
	@in_CustomerID int,
	@in_CharID int,
	@in_Slot int,
	@in_ItemID int,
...
CREATE PROCEDURE [WZ_Backpack_SRV_Change]
	@in_CustomerID int,
	@in_CharID int,
	@in_BackpackID int,
	@in_BackpackSize int
...
CREATE PROCEDURE [WZ_Backpack_SRV_DeleteItem] 
	@in_CustomerID int,
	@in_CharID int,
	@in_Slot int,
...
CREATE PROCEDURE [WZ_BackpackChange]
	@in_CustomerID int,
	@in_CharID int,
...
CREATE PROCEDURE [WZ_BackpackFromInv] 
	@in_CustomerID int,
	@in_CharID int,
	@in_InventoryID bigint,
	@in_Slot int,
...
CREATE PROCEDURE [WZ_BackpackGridJoin]
	@in_CustomerID int,
	@in_CharID int,
	@in_SlotFrom int,
	@in_SlotTo int
...
CREATE PROCEDURE [WZ_BackpackGridSwap] 
	@in_CustomerID int,
	@in_CharID int,
	@in_SlotFrom int,
	@in_SlotTo int
...
CREATE PROCEDURE [WZ_BackpackToInv] 
	@in_CustomerID int,
	@in_CharID int,
...
CREATE PROCEDURE [WZ_BuyItem_GD]
	@in_IP char(32),
	@in_CustomerID int,
	@in_ItemId int,
	@in_BuyDays int
...
CREATE PROCEDURE [WZ_BuyItem_GP]
	@in_IP char(32),
	@in_CustomerID int,
	@in_ItemId int,
	@in_BuyDays int
...
CREATE PROCEDURE [WZ_BuyItemFN_Exec]
...
CREATE PROCEDURE [WZ_BuyItemFN_GetPrice]
    @out_FNResult int out,
	@in_ItemId int,
	@in_BuyDays int,
...
CREATE PROCEDURE [WZ_Char_SRV_SetAttachments]
	@in_CustomerID int,
	@in_CharID int,
...
CREATE PROCEDURE [WZ_Char_SRV_SetStatus]
	@in_CustomerID int,
	@in_CharID int,
	@in_Alive int,
...
CREATE PROCEDURE [WZ_CharCreate] 
	@in_CustomerID int,
	@in_Hardcore int,
...
CREATE PROCEDURE [WZ_CharDelete] 
	@in_CustomerID int,
	@in_CharID int
AS
BEGIN
...
CREATE PROCEDURE [WZ_CharRevive]
	@in_CustomerID int,
	@in_CharID int
AS
BEGIN
...
CREATE PROCEDURE [WZ_ClanAddClanMembers]
	@in_CharID int,
	@in_ItemID int
AS
BEGIN
...
CREATE PROCEDURE [WZ_ClanApplyAnswer]
	@in_CharID int,
...
CREATE PROCEDURE [WZ_ClanApplyGetList]
	@in_CharID int
AS
BEGIN
	SET NOCOUNT ON;
...
CREATE PROCEDURE [WZ_ClanApplyToJoin]
	@in_CharID int,
	@in_ClanID int,
...
CREATE PROCEDURE [WZ_ClanCreate]
	@in_CustomerID int,
	@in_CharID int,
...
CREATE PROCEDURE [WZ_ClanCreateCheckMoney]
	@in_CustomerID int
AS
BEGIN
	SET NOCOUNT ON;
...
CREATE PROCEDURE [WZ_ClanCreateCheckParams]
	@in_CharID int,
	@in_ClanName nvarchar(64),
	@in_ClanTag nvarchar(4)
AS
...
CREATE PROCEDURE [WZ_ClanDonateToClanGP]
	@in_CustomerID int,
	@in_CharID int,
	@in_GP int
AS
...
CREATE PROCEDURE [WZ_ClanDonateToMemberGP]
	@in_CharID int,
	@in_GP int,
	@in_MemberID int
AS
...
CREATE PROCEDURE [WZ_ClanFN_DeleteClan]
	@in_ClanID int
AS
BEGIN
	SET NOCOUNT ON;
...
CREATE PROCEDURE [WZ_ClanGetEvents]
	@in_CharID int,
	@in_Days int
AS
BEGIN
...
CREATE PROCEDURE [WZ_ClanGetInfo]
	@in_ClanID int,
	@in_GetMembers int
AS
BEGIN
...
CREATE PROCEDURE [WZ_ClanGetPlayerData]
	@in_CharID int
AS
BEGIN
	SET NOCOUNT ON;
...
CREATE PROCEDURE [WZ_ClanInviteAnswer]
	@in_CharID int,
	@in_ClanInviteID int,
	@in_Answer int
AS
...
CREATE PROCEDURE [WZ_ClanInviteGetInvitesForPlayer]
	@in_CharID int
AS
BEGIN
	SET NOCOUNT ON;
...
CREATE PROCEDURE [WZ_ClanInviteReportAll]
	@in_CharID int
AS
BEGIN
	SET NOCOUNT ON;
...
CREATE PROCEDURE [WZ_ClanInviteSendToPlayer]
	@in_CharID int,
...
CREATE PROCEDURE [WZ_ClanKickMember]
	@in_CharID int,
	@in_MemberID int
AS
BEGIN
...
CREATE PROCEDURE [WZ_ClanSetLore]
	@in_CharID int,
...
CREATE PROCEDURE [WZ_ClanSetMemberRank]
	@in_CharID int,
	@in_MemberID int,
	@in_Rank int
AS
...
CREATE PROCEDURE [WZ_DB_GenerateDailyLeaderboard]
AS  
BEGIN  
	SET NOCOUNT ON;  
...
CREATE PROCEDURE [WZ_DB_GenerateLeaderboard]
AS  
BEGIN  
	SET NOCOUNT ON;  
...
CREATE PROCEDURE [WZ_DB_GenerateLeaderboard30]
AS  
BEGIN  
	SET NOCOUNT ON;  
...
CREATE PROCEDURE [WZ_DB_GenerateLeaderboard7]
AS  
BEGIN  
	SET NOCOUNT ON;  
...
CREATE PROCEDURE [WZ_GetAccountInfo1] 
	@in_CustomerID int,
	@in_CharID int
AS
BEGIN
...
CREATE PROCEDURE [WZ_GetAccountInfo2] 
	@in_CustomerID int,
	@in_CharID int
AS
BEGIN
...
CREATE PROCEDURE [WZ_GetDataGameRewards]
AS
BEGIN  
	SET NOCOUNT ON;  
...
CREATE PROCEDURE [WZ_GetItemsData] 
AS
BEGIN
	SET NOCOUNT ON;
...
CREATE PROCEDURE [WZ_GetShopInfo1] 
AS
BEGIN
	SET NOCOUNT ON;
...
CREATE PROCEDURE [WZ_LeaderboardGet]
	@in_Hardcore int,
	@in_Type int,
	@in_Page int
AS
...
CREATE PROCEDURE [WZ_SRV_AddCheatAttempt]
	@in_IP char(32),
	@in_CustomerID int,
...
CREATE PROCEDURE [WZ_SRV_AddLogInfo]
	@in_CustomerID int,
	@in_CharID int = 0,
...
CREATE PROCEDURE [WZ_SRV_AddWeaponStats] 
	@in_ItemID int,
	@in_ShotsFired int,
	@in_ShotsHits int,
	@in_KillsCQ int,
...
CREATE PROCEDURE [WZ_SRV_NoteAddNew]
	@in_CustomerID int,
	@in_CharID int,
	@in_GameServerID int,
...
CREATE PROCEDURE [WZ_SRV_NoteGetAll]
	@in_GameServerID int
AS
BEGIN
	SET NOCOUNT ON;
...
CREATE PROCEDURE [WZ_SRV_UserJoinedGame] 
	@in_CustomerID int,
	@in_CharID int,
	@in_GameMapId int,
...
CREATE PROCEDURE [WZ_SRV_UserJoinedGame2]
	@in_CustomerID int,
	@in_CharID int,
	@in_GameMapId int,
	@in_GameServerId bigint
...
CREATE PROCEDURE [WZ_SRV_UserLeftGame]
	@in_CustomerID int,
	@in_CharID int,
	@in_GameMapId int,
	@in_GameServerId bigint,
...
CREATE PROCEDURE [WZ_UpdateAchievementStatus]
	@in_CustomerID int,
	@in_AchID int,
	@in_AchValue int,
	@in_AchUnlocked int
...
CREATE PROCEDURE [WZ_UpdateLoginSession]
	@in_IP varchar(32),
	@in_CustomerID int,
	@in_SessionID int
AS
...
CREATE PROCEDURE [WZ_VITALSTATS_V1]
AS
BEGIN
...
-- ----------------------------
CREATE UNIQUE INDEX [IX_Accounts_email] ON [Accounts]
([email] ASC) 
GO
...
-- ----------------------------
CREATE INDEX [IX_Achievements_AchID] ON [Achievements]
([CustomerID] ASC) 
GO
CREATE INDEX [IX_Achievements_CustomerID] ON [Achievements]
([CustomerID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [CharsStats] ADD PRIMARY KEY ([CharID])
GO
...
-- ----------------------------
ALTER TABLE [CheatLog] ADD PRIMARY KEY ([ID])
GO

-- ----------------------------
-- Indexes structure for table ClanApplications
-- ----------------------------
CREATE INDEX [IX_ClanApplications_CharID] ON [ClanApplications]
([CharID] ASC) 
GO
CREATE INDEX [IX_ClanApplications_ClanID] ON [ClanApplications]
([ClanID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [ClanApplications] ADD PRIMARY KEY ([ClanApplicationID])
GO
...
-- ----------------------------
ALTER TABLE [ClanData] ADD PRIMARY KEY ([ClanID])
GO

-- ----------------------------
-- Indexes structure for table ClanEvents
-- ----------------------------
CREATE INDEX [IX_ClanEvents_ClanID] ON [ClanEvents]
([ClanID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [ClanEvents] ADD PRIMARY KEY ([ClanEventID])
GO

-- ----------------------------
-- Indexes structure for table ClanInvites
-- ----------------------------
CREATE INDEX [IX_ClanInvites_CustomerID] ON [ClanInvites]
([CharID] ASC) 
GO
CREATE INDEX [IX_ClanInvites_ClanID] ON [ClanInvites]
([ClanID] ASC) 
GO
CREATE INDEX [IX_ClanInvites_ExpireTime] ON [ClanInvites]
([ExpireTime] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [ClanInvites] ADD PRIMARY KEY ([ClanInviteID])
GO
...
-- ----------------------------
ALTER TABLE [DataGameRewards] ADD PRIMARY KEY ([ID])
GO
...
-- ----------------------------
ALTER TABLE [DataSkill2Price] ADD PRIMARY KEY ([SkillID])
GO
...
-- ----------------------------
ALTER TABLE [DBG_GPTransactions] ADD PRIMARY KEY ([TransactionID])
GO
...
-- ----------------------------
ALTER TABLE [DBG_IISApiStats] ADD PRIMARY KEY ([API])
GO

-- ----------------------------
-- Indexes structure for table DBG_LevelUpEvents
-- ----------------------------
CREATE INDEX [IX_DBG_LevelUpEvents] ON [DBG_LevelUpEvents]
([CustomerID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [DBG_PasswordResets] ADD PRIMARY KEY ([ResetID])
GO

-- ----------------------------
-- Indexes structure for table DBG_UserRoundResults
-- ----------------------------
CREATE INDEX [DBG_URR_CID_GRP] ON [DBG_UserRoundResults]
([CustomerID] ASC, [GameReportTime] ASC) 
GO
CREATE INDEX [IX_DBG_UserRoundResults_LBIdx1] ON [DBG_UserRoundResults]
([GameReportTime] ASC) 
...
-- ----------------------------
CREATE INDEX [IX_FinancialTransactions_CustomerID] ON [FinancialTransactions]
([CustomerID] ASC) 
GO
CREATE INDEX [IX_FinancialTransactions_DateTime] ON [FinancialTransactions]
([DateTime] ASC) 
GO
CREATE INDEX [IX_FinancialTransactions_ItemID] ON [FinancialTransactions]
([ItemID] ASC) 
GO
CREATE INDEX [IX_FinancialTransactions_TransactionType] ON [FinancialTransactions]
([TransactionType] ASC) 
GO
...
-- ----------------------------
CREATE INDEX [IDX_FriendsMap_CustomerID] ON [FriendsMap]
([CustomerID] ASC) 
GO
CREATE INDEX [IDX_FriendsMap_FriendID] ON [FriendsMap]
([FriendID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [Items_Attachments] ADD PRIMARY KEY ([ItemID])
GO
...
-- ----------------------------
ALTER TABLE [Items_Gear] ADD PRIMARY KEY ([ItemID])
GO
...
-- ----------------------------
ALTER TABLE [Items_Generic] ADD PRIMARY KEY ([ItemID])
GO
...
-- ----------------------------
ALTER TABLE [Items_Weapons] ADD PRIMARY KEY ([ItemID])
GO

-- ----------------------------
-- Indexes structure for table Leaderboard
-- ----------------------------
CREATE UNIQUE INDEX [IX_Leaderboard_CustomerID] ON [Leaderboard]
([CustomerID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [Leaderboard] ADD PRIMARY KEY ([Pos])
GO

-- ----------------------------
-- Indexes structure for table Leaderboard1
-- ----------------------------
CREATE UNIQUE INDEX [IX_Leaderboard1_CustomerID] ON [Leaderboard1]
([CustomerID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [Leaderboard1] ADD PRIMARY KEY ([Pos])
GO

-- ----------------------------
-- Indexes structure for table Leaderboard30
-- ----------------------------
CREATE UNIQUE INDEX [IX_Leaderboard30_CustomerID] ON [Leaderboard30]
([CustomerID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [Leaderboard30] ADD PRIMARY KEY ([Pos])
GO

-- ----------------------------
-- Indexes structure for table Leaderboard7
-- ----------------------------
CREATE UNIQUE INDEX [IX_Leaderboard7_CustomerID] ON [Leaderboard7]
([CustomerID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [Leaderboard7] ADD PRIMARY KEY ([Pos])
GO

-- ----------------------------
-- Indexes structure for table Logins
-- ----------------------------
CREATE INDEX [IX_Logins_CustomerID_LoginTime] ON [Logins]
...
-- ----------------------------
ALTER TABLE [Logins] ADD PRIMARY KEY ([LoginID])
GO
...
-- ----------------------------
ALTER TABLE [LoginSessions] ADD PRIMARY KEY ([CustomerID])
GO
...
-- ----------------------------
ALTER TABLE [MasterServerInfo] ADD PRIMARY KEY ([ServerID])
GO
...
-- ----------------------------
ALTER TABLE [SecurityLog] ADD PRIMARY KEY ([ID])
GO

-- ----------------------------
-- Indexes structure for table ServerNotesData
-- ----------------------------
CREATE INDEX [IX_ServerNotesData_GameServerId] ON [ServerNotesData]
([GameServerId] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [ServerNotesData] ADD PRIMARY KEY ([NoteID])
GO

-- ----------------------------
-- Indexes structure for table UsersChars
-- ----------------------------
CREATE INDEX [IX_UsersChars_ClanID] ON [UsersChars]
([ClanID] ASC) 
GO
CREATE INDEX [IX_UsersChars_Gamertag] ON [UsersChars]
([Gamertag] ASC) 
GO
CREATE INDEX [IX_Profile_Loadouts2_CustomerID] ON [UsersChars]
([CustomerID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [UsersChars] ADD PRIMARY KEY ([CharID])
GO

-- ----------------------------
-- Indexes structure for table UsersData
-- ----------------------------
CREATE INDEX [IX_LoginID_ClanID] ON [UsersData]
([ClanID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [UsersData] ADD PRIMARY KEY ([CustomerID])
GO

-- ----------------------------
-- Indexes structure for table UsersInventory
-- ----------------------------
CREATE INDEX [x_UsersInventory_Index_Fuck] ON [UsersInventory]
([CharID] ASC) 
INCLUDE ([BackpackSlot], [CustomerID], [InventoryID], [ItemID], [LeasedUntil], [Quantity], [Var1], [Var2]) 
GO
CREATE INDEX [IX_UsersInventory_CharID] ON [UsersInventory]
([CharID] ASC) 
GO
CREATE INDEX [IX_Inventory_CustomerID] ON [UsersInventory]
([CustomerID] ASC) 
GO
...
-- ----------------------------
ALTER TABLE [UsersInventory] ADD PRIMARY KEY ([InventoryID])
GO
