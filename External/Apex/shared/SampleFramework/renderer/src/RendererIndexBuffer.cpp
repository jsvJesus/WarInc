...
physx::PxU32 RendererIndexBuffer::getFormatByteSize(Format format)
{
	physx::PxU32 size = 0;
	switch(format)
	{
		case FORMAT_UINT16: size = sizeof(physx::PxU16); break;
		case FORMAT_UINT32: size = sizeof(physx::PxU32); break;
	}
...
physx::PxU32 RendererIndexBuffer::getMaxIndices(void) const
{
	return m_maxIndices;
}
