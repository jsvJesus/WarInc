...
#define HANDLE_PARAM_TYPE( datatype, paramFuncName ) { \
	...
	protected:
		...
		PvdConnection *mRemoteDebugger;
		physx::PxU64 mCurPvdObj;
		const char* mVariablePrefix;
		physx::PxU64 mDynamicArrayHandle;

	public:
		TopLevelParamTreeHandler( NxParameterized::Interface* obj, PvdConnection *remoteDebugger, physx::PxU64 inCurrentObject, const char* inVariablePrefix = NULL )
			: mObj( obj )
	...
	public:
		...
		virtual NxParameterized::ErrorType HandleDynamicArray( NxParameterized::Handle&, const char*){ return NxParameterized::ERROR_NONE; }
		...
		const physx::PxU32 GetPropertyCount() { return mProperties.size(); }
		const physx::PxU32* GetProperties() { return mProperties.begin(); }
		const PVD::PvdCommLayerDatatype* getDatatypes() { return mDatatypes.begin(); }
		bool HasRefs() { return hasRefs; }
	};
	...
	public:
		...
		virtual NxParameterized::ErrorType HandleDynamicArray( NxParameterized::Handle&, const char*){ return NxParameterized::ERROR_NONE; }
		virtual NxParameterized::ErrorType HandleProperty( const PvdCommLayerValue& , const char* ) { return NxParameterized::ERROR_NONE; }
	};
	...
	public:
		...
		virtual NxParameterized::ErrorType TraverseParamDefTree( NxParameterized::Handle& handle )
		{
			...
			if ( arraySize > 0 )
			{
				physx::PxU32 theClassKey( static_cast <physx::PxU32> (reinterpret_cast <size_t> (theDef)) );
	...
	NxParameterized::ErrorType TopLevelParamTreeHandler::HandleRef( NxParameterized::Handle& handle, const char* inParamName )
	{
		...
		if( includedRef )
		{
			...
			if( !refObj )
				return(NxParameterized::ERROR_INVLAID_REFERENCE_VALUE);
	...
	NxParameterized::ErrorType TopLevelParamTreeHandler::TraverseParamDefTree( NxParameterized::Handle &handle )
	{
		...
		case TYPE_MAT44:
			//mat44 unhandled for now
			//HANDLE_PARAM_TYPE( physx::PxMat44, getParamMat44 );
			break;
		case TYPE_BOUNDS3:
	...
	traverseParamDefTree(NxParameterized::Interface &obj, 
							PVD::PvdConnection *remoteDebugger,
							 void *curPvdObj,
