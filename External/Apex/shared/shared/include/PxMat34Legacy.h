...
public:
	...
	*/
	...
	PX_INLINE operator PxMat44() const
	{
		PxMat44 result;
	...
	*/
	PX_CUDA_MEMBER PX_INLINE PxVec3 operator*  (const PxVec3& src) const { PxVec3 dest; multiply(src, dest); return dest; }
	/**
	...
	*/
	...
	//! Add
	PX_CUDA_MEMBER PX_INLINE PxMat34Legacy operator+(const PxMat34Legacy& other) const
	{
	...
	PX_CUDA_MEMBER PX_INLINE PxMat34Legacy operator*(PxReal scalar) const
	{
