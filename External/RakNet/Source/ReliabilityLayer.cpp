...
{
	// RAKNET 4.023 FIX
	// RakPeer: Fix for random connection loss on slow systems. 
	// This is due to threading causing the last time an ack was received to be 
	// higher than the current time, thereby falsely returning true
	if(timeLastDatagramArrived > curTime)
		return false;
