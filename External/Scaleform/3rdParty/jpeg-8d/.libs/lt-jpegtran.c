...
/* ./.libs/lt-jpegtran.c - temporary wrapper executable for .libs/jpegtran
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/Scaleform/GFx/4.2/3rdParty/jpeg-8d/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/Scaleform/GFx/4.2/3rdParty/jpeg-8d/.libs:";
const char * TARGET_PROGRAM_NAME = "jpegtran"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# jpegtran - temporary wrapper script for .libs/jpegtran\n", f);
  ...
  fputs ("    echo \"jpegtran:jpegtran:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"jpegtran:jpegtran:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"jpegtran:jpegtran:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/Scaleform/GFx/4.2/3rdParty/jpeg-8d/.libs:$PATH\n", f);
  fputs ("\n", f);
