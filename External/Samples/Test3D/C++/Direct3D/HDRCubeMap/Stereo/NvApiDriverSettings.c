...
EValues_OGL_TEARING_FREE_SWAP_PRESENT g_valuesOGL_TEARING_FREE_SWAP_PRESENT[OGL_TEARING_FREE_SWAP_PRESENT_NUM_VALUES] = 
{
    OGL_TEARING_FREE_SWAP_PRESENT_DISABLE,
    OGL_TEARING_FREE_SWAP_PRESENT_PREFERENCE_MASK,
    OGL_TEARING_FREE_SWAP_PRESENT_FIFO,
    OGL_TEARING_FREE_SWAP_PRESENT_MOST_VISIBLE_PIXELS,
    OGL_TEARING_FREE_SWAP_PRESENT_LARGEST_WINDOW,
    OGL_TEARING_FREE_SWAP_PRESENT_ALLOWANCE_MASK,
    OGL_TEARING_FREE_SWAP_PRESENT_MODE_SPANNING,
    OGL_TEARING_FREE_SWAP_PRESENT_MODE_NO_SPANNING,
};
...
SettingDWORDNameString mapSettingDWORD[TOTAL_DWORD_SETTING_NUM] = 
{
    ...
    {OGL_TEARING_FREE_SWAP_PRESENT_ID,     OGL_TEARING_FREE_SWAP_PRESENT_STRING,      8, (NvU32 *)g_valuesOGL_TEARING_FREE_SWAP_PRESENT, OGL_TEARING_FREE_SWAP_PRESENT_DISABLE},
    ...
    {AA_BEHAVIOR_FLAGS_ID,                 AA_BEHAVIOR_FLAGS_STRING,                 17, (NvU32 *)g_valuesAA_BEHAVIOR_FLAGS,       AA_BEHAVIOR_FLAGS_DEFAULT},
    ...
    {AA_MODE_REPLAY_ID,                    AA_MODE_REPLAY_STRING,                    18, (NvU32 *)g_valuesAA_MODE_REPLAY,          0x00000000},
    ...
    {WKS_API_STEREO_MODE_ID,               WKS_API_STEREO_MODE_STRING,               22, (NvU32 *)g_valuesWKS_API_STEREO_MODE,     WKS_API_STEREO_MODE_SHUTTER_GLASSES},
